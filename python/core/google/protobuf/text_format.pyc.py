...
# Compiled at: 2018-04-17 17:38:14
...
def PrintField(field, value, out, indent=0, as_utf8=False, as_one_line=False):
    ...
    if field.is_extension:
        out.write('[')
        if field.containing_type.GetOptions().message_set_wire_formatand field.type == descriptor.FieldDescriptor.TYPE_MESSAGE and field.type == descriptor.FieldDescriptor.TYPE_MESSAGE and field.label == descriptor.FieldDescriptor.LABEL_OPTIONAL:
