...
class AutoFactoryInit:
 ...
 L. 903         0  LOAD_GLOBAL              set
                2  CALL_FUNCTION_0       0  '0 positional arguments'
                4  STORE_FAST               'names'

 L. 904         6  LOAD_FAST                'self'
                8  LOAD_ATTR                AUTO_INIT_KWARGS
               10  LOAD_CONST               None
               12  COMPARE_OP               is
               14  POP_JUMP_IF_FALSE    26  'to 26'

 L. 905        16  LOAD_FAST                'names'
 ...
 L. 906        26  LOAD_FAST                'self'
               28  LOAD_ATTR                AUTO_INIT_KWARGS
               30  POP_JUMP_IF_FALSE    44  'to 44'

 L. 907        32  LOAD_FAST                'names'
               34  LOAD_METHOD              update
               36  LOAD_FAST                'self'
               38  LOAD_ATTR                AUTO_INIT_KWARGS
               40  CALL_METHOD_1         1  '1 positional argument'
               42  POP_TOP          
             44_0  COME_FROM            30  '30'

 L. 908        44  LOAD_FAST                'self'
               46  LOAD_ATTR                AUTO_INIT_OPTIONAL_KWARGS
               48  POP_JUMP_IF_FALSE    62  'to 62'

 L. 909        50  LOAD_FAST                'names'
               52  LOAD_METHOD              update
               54  LOAD_FAST                'self'
               56  LOAD_ATTR                AUTO_INIT_OPTIONAL_KWARGS
               58  CALL_METHOD_1         1  '1 positional argument'
               60  POP_TOP          
             62_0  COME_FROM            48  '48'

 L. 911        62  SETUP_LOOP          172  'to 172'
               64  LOAD_FAST                'names'
               66  GET_ITER         
             68_0  COME_FROM           168  '168'
             68_1  COME_FROM           164  '164'
             68_2  COME_FROM           120  '120'
             68_3  COME_FROM           102  '102'
             68_4  COME_FROM            92  '92'
             68_5  COME_FROM            78  '78'
               68  FOR_ITER            170  'to 170'
               70  STORE_FAST               'name'

 L. 912        72  LOAD_FAST                'name'
               74  LOAD_FAST                'kwargs'
               76  COMPARE_OP               in
               78  POP_JUMP_IF_FALSE_LOOP    68  'to 68'

 L. 913        80  LOAD_FAST                'kwargs'
               82  LOAD_METHOD              pop
               84  LOAD_FAST                'name'
 ...
 L. 921        92  CONTINUE             68  'to 68'
             94_0  COME_FROM            90  '90'

 L. 922        94  LOAD_FAST                'value'
               96  LOAD_FAST                'self'
               98  LOAD_ATTR                AUTO_INIT_IGNORE_VALUE
              100  COMPARE_OP               !=
              102  POP_JUMP_IF_FALSE_LOOP    68  'to 68'

 L. 923       104  SETUP_EXCEPT        122  'to 122'

 L. 924       106  LOAD_GLOBAL              setattr
              108  LOAD_FAST                'self'
              110  LOAD_FAST                'name'
              112  LOAD_FAST                'value'
              ...
              116  POP_TOP          
              118  POP_BLOCK        
              120  JUMP_LOOP            68  'to 68'
            122_0  COME_FROM_EXCEPT    104  '104'

 L. 925       122  DUP_TOP          
              124  LOAD_GLOBAL              AttributeError
              126  COMPARE_OP               exception-match
              128  POP_JUMP_IF_FALSE   166  'to 166'
              130  POP_TOP          
              132  POP_TOP          
              134  POP_TOP          

 L. 926       136  LOAD_GLOBAL              logger
              138  LOAD_METHOD              error
              140  LOAD_STR                 "Can't set attribute {}.{} to {}."
              142  LOAD_METHOD              format
              144  LOAD_GLOBAL              type
              146  LOAD_FAST                'self'
              148  CALL_FUNCTION_1       1  '1 positional argument'
              150  LOAD_ATTR                __name__
              152  LOAD_FAST                'name'
              154  LOAD_FAST                'value'
              156  CALL_METHOD_3         3  '3 positional arguments'
              158  CALL_METHOD_1         1  '1 positional argument'
              160  POP_TOP          
              162  POP_EXCEPT       
              164  JUMP_LOOP            68  'to 68'
            166_0  COME_FROM           128  '128'
              166  END_FINALLY      
              168  JUMP_LOOP            68  'to 68'
              170  POP_BLOCK        
            172_0  COME_FROM_LOOP       62  '62'

 L. 932       172  SETUP_EXCEPT        192  'to 192'

 L. 933       174  LOAD_GLOBAL              super
              176  CALL_FUNCTION_0       0  '0 positional arguments'
              178  LOAD_ATTR                __init__
              180  LOAD_FAST                'args'
              182  LOAD_FAST                'kwargs'
              184  CALL_FUNCTION_EX_KW     1  'keyword and positional arguments'
              186  POP_TOP          
              188  POP_BLOCK        
              190  JUMP_FORWARD        214  'to 214'
            192_0  COME_FROM_EXCEPT    172  '172'

 L. 934       192  DUP_TOP          
              194  LOAD_GLOBAL              TypeError
 ...
 L. 935       206  RAISE_VARARGS_0       0  'reraise'
              208  POP_EXCEPT       
...
Parse error at or near `CONTINUE' instruction at offset 92
...
class TunableList(_TunableCollection):
    ...
    def _get_collection_types(self):
        return (
         list, list.append, tuple, self._is_final_node)
    ...
    def _process_dict_value(self, value, tunable_name, source):
        if value is not None:
            ...
            if False and self.allow_none:
                dict_items = {getattr(item, key_name): getattr(item, value_name) for item in }
            else:
                dict_items = {getattr(item, key_name): getattr(item, value_name) for item in  if getattr(item, value_name) is not None}
            ...
            if node is None:
                ...
                if node.text is None:
                    ...
                    try:
                        ...
                        if not self._class_restrictions or value is not None:
...
class TunableResourceKeyReferenceBase(_TunableHasPackSafeMixin, Tunable):
    ...
    def load_etree_node(self, node, source, expect_error):
        ...
        if error is not None:
            ...
            pass
        if self.pack_safe:
            if not self._does_resource_key_exist(value):
                raise UnavailablePackSafeResourceError
            return value
...
class TunableResourceKey(_TunableHasPackSafeMixin, Tunable):
    ...
    def load_etree_node(self, node, source, expect_error):
        value = super().load_etree_node(node, source, expect_error)
        if not self.pack_safe or self.validate_pack_safe:
