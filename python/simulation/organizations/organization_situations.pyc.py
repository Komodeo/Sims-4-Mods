...
class OrganizationMemberSingleJobSituation(OrganizationEventBase):
    ...
    def _states(cls):
        return (
         SituationStateData(1, SituationState),)

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.job_and_role_state.job, cls.job_and_role_state.role_state)]
...
class FestivalOrganizationEventType(BaseGenericFestivalSituation):
    ...
    def _states(cls):
        return (
         SituationStateData(1, GatherEventSituationState, factory=(cls.gather_state)),
