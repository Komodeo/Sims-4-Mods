...
# Compiled at: 2015-07-06 13:18:46
...
class PartyPooperSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _PartyPooperState, factory=(cls.party_pooper_state)),)

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.party_pooper_job_and_role.job, cls.party_pooper_job_and_role.role_state)]
