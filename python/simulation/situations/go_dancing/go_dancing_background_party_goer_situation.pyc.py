...
# Compiled at: 2015-07-06 19:03:37
...
class GoDancingBackgroundPartyGoerSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _PartyGoerState, factory=(cls.party_goer_state)),)

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.party_goer_job_and_role.job, cls.party_goer_job_and_role.role_state)]
