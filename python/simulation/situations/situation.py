                    ...
                    for guest_id in guest_ids:
                        ...
                        if guest_info is not None:
                            ...
                            if travel_group is not None:
                                ...
                                if travel_group_zone_id is not None:
                                    if travel_group_zone_id:
                                        if travel_group_zone_id not in possible_zones:
    ...
    def get_prepopulated_job_for_sims(cls, sim, target_sim_id=None):
        if target_sim_id:
            if cls.targeted_situation is not None:
                ...
                if sim_info is None:
                    return
                prepopulated = [(sim.id, cls.targeted_situation.actor_job.guid64),
                 (
