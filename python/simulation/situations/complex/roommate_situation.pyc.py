...
# Compiled at: 2019-02-13 09:34:49
...
class RoommateSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _RoommateSituationState),)
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.roommate_situation_job_and_role_state.job, cls.roommate_situation_job_and_role_state.role_state)]
