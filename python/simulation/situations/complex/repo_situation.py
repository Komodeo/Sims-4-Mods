...
# Compiled at: 2020-04-30 12:22:36
...
class _IdleAtObjectState(CommonSituationState):
    ...
    def handle_event(self, sim_info, event, resolver):
        ...
        if not event == TestEvent.InteractionComplete and repo_person is not None or sim_info is repo_person.sim_info and resolver(self.owner.bribe_interaction):
...
class RepoSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _WaitForRepoPersonState),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.repo_person_job_and_role_state.job, cls.repo_person_job_and_role_state.role_state),
         (
