...
# Compiled at: 2021-05-19 12:28:52
...
class MusicPerformanceSituation(BaseGenericFestivalSituation):
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.artist_job_and_role.job, cls.artist_job_and_role.role_state),
         (
    ...
    def _states(cls):
        return (
         SituationStateData(1, _ArtistEnterState, factory=(cls.artist_enter_state)),
