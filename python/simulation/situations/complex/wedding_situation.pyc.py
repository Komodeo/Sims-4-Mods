...
class WeddingSituation(situations.situation_complex.SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, GatherState),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.betrothed.situation_job, cls.betrothed.betrothed_gather_role_state), (cls.bartender.situation_job, cls.bartender.bartender_prep_role_state), (cls.caterer.situation_job, cls.caterer.caterer_prep_role_state), (cls.guest.situation_job, cls.guest.guest_gather_role_state), (cls.entertainer.situation_job, cls.entertainer.entertainer_prep_role_state)]
