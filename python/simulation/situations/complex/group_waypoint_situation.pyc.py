...
# Compiled at: 2021-05-04 11:45:50
...
class _GroupWaypointInteractState(CommonSituationState):
    ...
    def on_activate(self, reader=None):
        ...
        if reader is None:
            ...
            if not self.owner is not None or self._num_queued_interactions == 0:
                self._route_to_next_waypoint()
        else:
...
class GroupWaypointSituation(SituationComplexCommon):
    ...
    class _PredefinedWaypointStrategy(HasTunableSingletonFactory, AutoFactoryInit, _GroupWaypointStrategy):
        ...
        def get_next_interaction_choices(self, leader_sim, resolver, current_count, min_waypoints):
            ...
            return (
             self.interaction_tuning.get(self.current_waypoint, None), complete, advance)
    ...
    def _states(cls):
        return (
         SituationStateData(1, _GroupWaypointStartState, factory=(cls.starting_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.leader_job_and_role.job, cls.leader_job_and_role.role_state),
         (
    ...
    def on_sim_removed_from_social_group(self, sim, finishing_type):
        if sim is self.leader_sim:
            ...
            if finishing_type is not FinishingType.SOCIALS:
    ...
    def _set_next_interaction(self):
        ...
        while self._next_interaction is None:
