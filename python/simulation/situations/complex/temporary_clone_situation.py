...
# Compiled at: 2020-11-13 09:10:40
...
class TemporaryCloneSituation(situations.situation_complex.SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _TemporaryCloneState, factory=(cls.be_clone_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.clone_job_and_role_state.job, cls.clone_job_and_role_state.role_state)]
