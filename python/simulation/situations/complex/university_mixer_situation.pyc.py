...
# Compiled at: 2019-10-18 16:32:53
...
class UniversityMixerPartySituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _SetupJuiceKeg, factory=(cls.setup_juice_keg_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.juice_keg_bearer_job_and_role.job, cls.juice_keg_bearer_job_and_role.role_state)]
