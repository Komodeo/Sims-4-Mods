...
class PetCareSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(cls.WAIT_FOR_PET_CARE_WORKER_STATE_UID, _WaitForPetCareWorkerState),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.pet_care_worker_job_and_role_state.job, cls.pet_care_worker_job_and_role_state.role_state),
         (
