...
class PreWelcomeWagon(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _HasFrontDoorSituationStartingState, factory=(cls.has_front_door_situation_starting_state)),
...
class WelcomeWagon(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(3, _WaitToBeLetInState, factory=(cls.wait_to_be_let_in_state)),
