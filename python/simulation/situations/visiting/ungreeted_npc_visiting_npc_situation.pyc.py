...
# Compiled at: 2016-04-20 14:52:32
...
class UngreetedNPCVisitingNPCSituation(VisitingNPCSituation):
    ...
    def _states(cls):
        return (
         SituationStateData(1, UngreetedNPCVisitingNPCState),)

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.ungreeted_npc_sims.situation_job, cls.ungreeted_npc_sims.role_state)]
