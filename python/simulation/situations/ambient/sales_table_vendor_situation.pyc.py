...
# Compiled at: 2020-03-12 13:11:10
...
class SalesTableVendorSituationMixin:
    ...
    def _states(cls):
        return (
         SituationStateData(1, SalesTableSetupState, factory=(cls.setup_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.vendor_job_and_role_state.job, cls.vendor_job_and_role_state.role_state)]
