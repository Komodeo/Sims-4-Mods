...
def debugvis_simposition_start(opt_sim: OptionalTargetParam=None, _connection=None):
    if opt_sim is None:
        ...
        if not _start_sim_visualizer(opt_sim, _connection, 'sim_pos', _sim_layer_visualizers, SimPositionVisualizer):
            return 0
    return 1
...
def debugvis_simposition_stop(opt_sim: OptionalTargetParam=None, _connection=None):
    if opt_sim is None:
        ...
        if not _stop_sim_visualizer(opt_sim, _connection, 'sim_pos', _sim_layer_visualizers):
            return 0
    return 1
...
def debugvis_mood_toggle(_connection=None):
    ...
    if not old_registered or new_registered:
