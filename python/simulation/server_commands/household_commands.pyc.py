...
def _transfer_sims_main(proto, source_household, target_household):
    ...
    if source_household.is_player_household is not target_household.is_player_household:
        if not source_household.is_player_household or proto.to_source_sims:
    ...
    if proto.funds > 0:
        ...
        sim_info_manager = (target_household.destroy_household_if_empty() or services.sim_info_manager)()
