...
# Compiled at: 2020-11-20 01:48:58
...
def _parse_state(state, _connection=None):
    ...
    if not state_lower == 'on':
        if state_lower == 'true' or state_lower == 'full' or state_lower == '3':
...
def _parse_randomization(randomization):
    ...
    if not randomization_lower == 'on':
        if randomization_lower == 'true' or randomization_lower == 'enabled':
...
def override_disable_autonomous_multitasking_if_user_directed(enabled=None, _connection=None):
    if enabled is None:
        ...
        if enabled_lower == 'on' or enabled_lower == 'true' or enabled_lower == 'enabled':
            ...
            if enabled_lower == 'off' or enabled_lower == 'false' or enabled_lower == 'disabled':
                to_enabled = False
            else:
                if enabled_lower == 'undefined' or enabled_lower == 'default':
