...
# Compiled at: 2017-11-06 11:04:35
...
class VetClinicZoneDirector(BusinessZoneDirectorMixin, VisitorSituationOnArrivalZoneDirectorMixin, SchedulingZoneDirector):
    ...
    def _process_traveled_sim(self, sim_info):
        ...
        if not ((current_zone.is_first_visit_to_zone or current_zone.time_has_passed_in_world_since_zone_save() or current_zone.active_household_changed_between_save_and_load() or sim_info.startup_sim_location) is not None and services.active_lot().is_position_on_lot(sim_info.startup_sim_location.transform.translation)):
    ...
    def get_zone_outfit(self, sim_info):
        ...
        return (
         outfit_data, (OutfitCategory.CAREER, outfit_index))
