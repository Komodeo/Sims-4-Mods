...
# Compiled at: 2018-07-22 14:25:27
...
class VetCustomerGroupSituation(BusinessSituationMixin, SituationComplexCommon):
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.owner_job_and_initial_role.job, cls.owner_job_and_initial_role.role_state),
         (
    ...
    def _get_pet_and_owner_sim_infos(self):
        ...
        return (
         pet_sim_info, pet_owner_sim_info)
    ...
    def get_payment_data(self):
        ...
        return (
         self._treatment_cost, self._sickness_difficulty, self._award_difficulty_bonus)
