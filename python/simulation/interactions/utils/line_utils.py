...
# Compiled at: 2020-09-25 11:11:51
...
def get_wait_in_line_together_situation(sim, target_id, line_key):
    ...
    for situation in situation_manager.get_situations_sim_is_in(sim):
        if type(situation) is LineUtils.WAIT_IN_LINE_TOGETHER_SITUATION:
            if situation.line_key == line_key:
                if situation.line_interaction_target_id == target_id:
                    return situation
