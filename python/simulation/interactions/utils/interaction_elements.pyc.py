...
# Compiled at: 2021-06-10 15:35:49
    ...
    def validate_tuning_interaction(cls, interaction, basic_extra):
        ...
        if interaction.one_shot and interaction.basic_content.animation_ref is None:
            ...
            if interaction.staging:
                ...
                if not staging_content.affordance_links is None and staging_content.phase_tuning is None or interaction.basic_content.animation_ref is None:
                    if interaction.provided_posture_type is None:
                        ...
                        if interaction.provided_posture_type._animation_data is None:
