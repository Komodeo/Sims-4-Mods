...
# Compiled at: 2019-07-03 12:52:01
...
def generate_statistics():
    ...
    for obj in all_objects:
        if obj.is_on_active_lot():
            ...
            if (obj.definition.has_build_buy_tag)(*PerformanceHandlerTuning.DECORATIVE_OBJECT_TAGS_OPEN_STREET):
    ...
    def fill_gsi_object_location_histogram_entry(object_location_pair, frequency, object_name_func=None):
        ...
        return {'name':obj_name, 
         'location':object_location_pair[1],  'frequency':frequency}
