    ...
    def __call__(self, test_targets=(), **kwargs):
        for target in test_targets:
            ...
            if self.whitelist_outfits:
                if not any((outfit[0] == whitelist_category for whitelist_category in self.whitelist_outfits)):
                ...
                if outfit_addition_test is not None:
                    ...
                    if outfit_addition_test.test_type == self.TEST_CANNOT_ADD:
                        if outfits_in_category is None or len(outfits_in_category) < get_maximum_outfits_for_category(outfit_category):
