...
class SimSpawner:
    ...
    def spawn_sim(cls, sim_info, sim_position: sims4.math.Vector3=None, sim_location=None, sim_spawner_tags=None, spawn_point_option=None, saved_spawner_tags=None, spawn_action=None, additional_fgl_search_flags=None, from_load=False, is_debug=False, use_fgl=True, spawn_point=None, spawn_at_lot=True, update_skewer=True, use_random_sim_spawner_tag=True, **kwargs):
        if not is_debug or disable_spawning_non_selectable_sims:
        ...
        if household is None:
            ...
            if household.id == 0:
                ...
                for index, sim_data in enumerate(new_sim_data['sims']):
                    ...
                    if (last_name or last_name_key or last_name_key) is not UNSET and not sim_creators[index].full_name_key:
                        if sim_name_type == SimNameType.DEFAULT:
