...
# Compiled at: 2016-09-16 14:53:59
...
class KaraokeContestSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _KaraokeContestSituationState),)

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.contestant_job_and_role.job, cls.contestant_job_and_role.role_state)]
