...
# Compiled at: 2019-03-07 17:16:03
        ...
        for attractor_tuning in self.attractors:
            ...
            for attractor_id in self._attractor_ids[attractor_tuning]:
                ...
                if not attractor:
                    ...
                    if not any((attractor.position == loc[0] and attractor.orientation == loc[1] for loc in self._valid_attractor_positions[attractor_tuning])):
                        attractor.destroy()
                        attractor_IDs_to_remove.append(attractor_id)
                    else:
