...
# Compiled at: 2019-11-06 15:04:00
...
class CreateAndAddToSituation(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    def _verify_tunable_callback(instance_class, tunable_name, source, value):
        if value.situation_job is not None:
            ...
            if value.situation_to_create.default_job() is None:
    ...
    FACTORY_TUNABLES = {'description':'Create a new situation of this type and add the NPC to its tuned job.',  'situation_to_create':Situation.TunableReference(pack_safe=True), 
