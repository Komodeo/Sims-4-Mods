...
# Compiled at: 2021-05-26 19:00:12
...
class OpenStreetDirectorBase(HasTunableReference, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.OPEN_STREET_DIRECTOR)):
    ...
    def _should_load_old_data--- This code section failed: ---

 L. 239         0  LOAD_GLOBAL              services
                2  LOAD_METHOD              current_zone
                4  CALL_METHOD_0         0  '0 positional arguments'
                6  LOAD_METHOD              time_has_passed_in_world_since_open_street_save
                8  CALL_METHOD_0         0  '0 positional arguments'
               10  POP_JUMP_IF_FALSE    18  'to 18'

 L. 240        12  LOAD_FAST                'self'
               14  LOAD_ATTR                allow_loading_after_time_passes_elsewhere
               16  POP_JUMP_IF_FALSE    28  'to 28'
             18_0  COME_FROM            10  '10'

 L. 241        18  LOAD_FAST                'street_director_proto'
               20  LOAD_METHOD              HasField
               22  LOAD_STR                 'resource_key'
               24  CALL_METHOD_1         1  '1 positional argument'
               26  POP_JUMP_IF_TRUE     32  'to 32'
             28_0  COME_FROM            16  '16'

 L. 242        28  LOAD_CONST               False
               30  RETURN_VALUE     
             32_0  COME_FROM            26  '26'

 L. 243        32  LOAD_GLOBAL              sims4
               34  LOAD_ATTR                resources
               36  LOAD_METHOD              get_key_from_protobuff
               38  LOAD_FAST                'street_director_proto'
               40  LOAD_ATTR                resource_key
               42  CALL_METHOD_1         1  '1 positional argument'
               44  STORE_FAST               'previous_resource_key'

 L. 244        46  LOAD_FAST                'previous_resource_key'
               48  LOAD_FAST                'self'
               50  LOAD_ATTR                resource_key
               52  COMPARE_OP               ==
               54  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `LOAD_GLOBAL' instruction at offset 32
