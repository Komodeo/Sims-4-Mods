...
# Compiled at: 2021-06-28 18:38:10
...
class GenericOneStateFestivalAttendeeSituation(BaseGenericFestivalSituation):
    ...
    def _states(cls):
        return (
         SituationStateData(1, StartingFestivalSituationState, factory=(cls.initial_state)),
...
class GenericTwoStateFestivalAttendeeSituation(BaseGenericFestivalSituation):
    ...
    def _states(cls):
        return (
         SituationStateData(1, StartingTransitioningFestivalSituationState, factory=(cls.initial_state)),
...
class SelectableSimFestivalSituation(BaseGenericFestivalSituation):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _SelectableSimsBackgroundSituationState),
         SituationStateData(2, CooldownFestivalSituationState, factory=(cls.cooldown_state)))
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.job_and_role.job, cls.job_and_role.role_state)]
...
class MultiSimFestivalSituation(BaseGenericFestivalSituation):
    ...
    def _states(cls):
        return (
         SituationStateData(1, MultiSimStartingFestivalSituationState, factory=(cls.initial_state)),
         SituationStateData(2, CooldownFestivalSituationState, factory=(cls.cooldown_state)))
...
class FestivalPerformanceSpaceBuskerSituation(BuskerSituationMixin, BaseGenericFestivalSituation):
    ...
    def _states(cls):
        return (
         SituationStateData(1, BuskSituationState, factory=(cls.busk_state)),
         SituationStateData(2, CooldownFestivalSituationState, factory=(cls.cooldown_state)))
