...
# Compiled at: 2018-07-22 14:17:14
...
class NeighborHangoutSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _RingDoorbellState, factory=(cls._ring_doorbell_state)),
    ...
    def situation_meets_starting_requirements(cls, **kwargs):
        ...
        if not (owning_household is None or owning_household.get_sims_at_home()):
            return False
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.neighbor_job_and_default_role_state.job, cls.neighbor_job_and_default_role_state.role_state),
         (
