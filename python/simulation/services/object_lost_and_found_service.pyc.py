...
# Compiled at: 2021-06-28 11:47:26
        ...
        if sim_info is not None:
            if sim_info.is_instanced():
                if sim_info.zone_id != locator.zone_id:
                    if locator.return_to_individual_sim or not self._any_household_member_on_lot(locator.zone_id, sim_info.household.id, sim_info.id):
                        ...
                        if sim_info is None:
                            if not self._any_household_member_on_lot(locator.zone_id, locator.household_id, locator.sim_id):
