...
# Compiled at: 2022-04-20 17:37:17
...
class StoryProgressionService(Service):
 ...
 L. 425       128  SETUP_LOOP          208  'to 208'
              ...
              134  GET_ITER         
            136_0  COME_FROM           156  '156'
            136_1  COME_FROM           148  '148'
 ...
 L. 461   368_370  SETUP_LOOP          950  'to 950'
              ...
              378  GET_ITER         
            380_0  COME_FROM           944  '944'
          380_382  FOR_ITER            948  'to 948'
              384  STORE_FAST               'i'

 L. 463   386_388  SETUP_LOOP          944  'to 944'
            390_0  COME_FROM           898  '898'
            390_1  COME_FROM           658  '658'
            390_2  COME_FROM           612  '612'
            390_3  COME_FROM           578  '578'
...
Parse error at or near `CONTINUE' instruction at offset 612_614
 ...
 L. 661        16  LOAD_CLOSURE             'self'
               ...
               26  MAKE_FUNCTION_CLOSURE        'closure'
               28  LOAD_DEREF               'self'
 ...
 L. 662        38  LOAD_FAST                'trackers'
               ...
               52  MAKE_FUNCTION_CLOSURE        'closure'
               54  LOAD_DEREF               'self'
 ...
 L. 663        66  SETUP_LOOP          234  'to 234'
             68_0  COME_FROM           230  '230'
             68_1  COME_FROM           150  '150'
...
Parse error at or near `COME_FROM' instruction at offset 232_0
    ...
    def _clear_chapter_history(self, chapter):
        ...
        if tracker.tracker_type is StoryType.SIM_BASED:
            ...
            if tracker.tracker_type is StoryType.HOUSEHOLD_BASED:
