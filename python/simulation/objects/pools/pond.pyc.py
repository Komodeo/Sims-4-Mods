...
# Compiled at: 2021-06-01 15:18:39
...
class Pond(GameObject):
    ...
    def _get_fishing_target_location(self, edge_start, edge_stop):
        ...
        if not (fishing_target_position is None or self.validate_fishing_target_position(fishing_target_position, edge_midpoint)):
            return
    ...
    def get_target_positions_to_fishing_constraints(self):
        ...
        while len(self._target_positions_to_fishing_constraints) < constraint_constants.minimum_constraints_per_pond:
            for sublist in constraints_per_sublists:
                ...
                if has_iterated_once:
                    if len(self._target_positions_to_fishing_constraints) >= constraint_constants.minimum_constraints_per_pond:
                        break
