            ...
            if object_tests:
                ...
                for tooltip_key, tooltip_text in tooltip_data.tooltip_fields.items():
                    ...
                    if tooltip_key == TooltipFields.rel_override_id:
                        if len(tokens) == 0 or tooltip_text.text_tokens.tokens[0].obj_property is None:
                            ...
                            yield (
                             TooltipFieldsComplete(tooltip_key).name, tokens[0], tooltip_text.override_component_information)
                    else:
                        if tooltip_key == TooltipFields.simoleon_text:
