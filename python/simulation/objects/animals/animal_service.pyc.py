...
class AnimalService(Service):
 ...
 L. 290         0  LOAD_GLOBAL              GameplaySaveData_pb2
                2  LOAD_METHOD              PersistableAnimalService
                4  CALL_METHOD_0         0  '0 positional arguments'
                6  STORE_FAST               'service_data'

 L. 291         8  LOAD_GLOBAL              services
               10  LOAD_METHOD              object_manager
               12  CALL_METHOD_0         0  '0 positional arguments'
               14  STORE_FAST               'object_manager'

 L. 293        16  SETUP_LOOP          262  'to 262'
               18  LOAD_FAST                'self'
               20  LOAD_ATTR                _animal_assignment_map
               22  LOAD_METHOD              items
               24  CALL_METHOD_0         0  '0 positional arguments'
               26  GET_ITER         
             28_0  COME_FROM           258  '258'
             28_1  COME_FROM           186  '186'
             28_2  COME_FROM           122  '122'
             28_3  COME_FROM            56  '56'
               28  FOR_ITER            260  'to 260'
               30  UNPACK_SEQUENCE_2     2 
               32  STORE_FAST               'animal_id'
               34  STORE_FAST               'home_data'

 L. 295        36  LOAD_GLOBAL              services
               38  LOAD_METHOD              current_zone
               40  CALL_METHOD_0         0  '0 positional arguments'
               42  LOAD_ATTR                is_in_build_buy
               44  POP_JUMP_IF_FALSE    58  'to 58'

 L. 296        46  LOAD_FAST                'self'
               48  LOAD_METHOD              _is_obj_destroyed_in_bb
               50  LOAD_FAST                'animal_id'
               52  CALL_METHOD_1         1  '1 positional argument'
               54  POP_JUMP_IF_FALSE    58  'to 58'

 L. 297        56  CONTINUE             28  'to 28'
             58_0  COME_FROM            54  '54'
             58_1  COME_FROM            44  '44'

 L. 298        58  LOAD_GLOBAL              ProtocolBufferRollback
               60  LOAD_FAST                'service_data'
               62  LOAD_ATTR                animal_data
               64  CALL_FUNCTION_1       1  '1 positional argument'
               66  SETUP_WITH          252  'to 252'
               68  STORE_FAST               'animal_data'

 L. 299        70  LOAD_FAST                'animal_id'
               72  LOAD_FAST                'animal_data'
               74  STORE_ATTR               obj_id

 L. 300        76  LOAD_FAST                'self'
               78  LOAD_ATTR                _registered_animals
               80  LOAD_FAST                'animal_id'
               82  BINARY_SUBSCR    
               84  LOAD_FAST                'animal_data'
               86  STORE_ATTR               animal_type

 L. 301        88  LOAD_FAST                'home_data'
               90  LOAD_CONST               None
               92  COMPARE_OP               is-not
               94  POP_JUMP_IF_FALSE   248  'to 248'

 L. 302        96  LOAD_FAST                'home_data'
               98  LOAD_ATTR                id
              100  STORE_FAST               'home_id'

 L. 305       102  LOAD_GLOBAL              services
              104  LOAD_METHOD              current_zone
              106  CALL_METHOD_0         0  '0 positional arguments'
              108  LOAD_ATTR                is_in_build_buy
              110  POP_JUMP_IF_FALSE   188  'to 188'

 L. 306       112  LOAD_FAST                'self'
              114  LOAD_METHOD              _is_obj_destroyed_in_bb
              116  LOAD_FAST                'home_id'
              118  CALL_METHOD_1         1  '1 positional argument'
              120  POP_JUMP_IF_FALSE   124  'to 124'

 L. 307       122  CONTINUE_LOOP        28  'to 28'
            124_0  COME_FROM           120  '120'

 L. 308       124  LOAD_FAST                'home_data'
              126  LOAD_ATTR                persist_assignment_in_household_inventory
              128  POP_JUMP_IF_TRUE    188  'to 188'

 L. 309       130  LOAD_FAST                'self'
              132  LOAD_METHOD              _is_obj_modified_in_bb
              134  LOAD_FAST                'animal_id'
              136  CALL_METHOD_1         1  '1 positional argument'
              138  POP_JUMP_IF_TRUE    150  'to 150'
              140  LOAD_FAST                'self'
              142  LOAD_METHOD              _is_obj_modified_in_bb
              144  LOAD_FAST                'home_id'
              146  CALL_METHOD_1         1  '1 positional argument'
              148  POP_JUMP_IF_FALSE   188  'to 188'
            150_0  COME_FROM           138  '138'

 L. 310       150  LOAD_FAST                'object_manager'
              152  LOAD_METHOD              get
              154  LOAD_FAST                'animal_id'
              156  CALL_METHOD_1         1  '1 positional argument'
              158  STORE_FAST               'animal'

 L. 311       160  LOAD_FAST                'object_manager'
              162  LOAD_METHOD              get
              164  LOAD_FAST                'home_id'
              166  CALL_METHOD_1         1  '1 positional argument'
              168  STORE_FAST               'home'

 L. 312       170  LOAD_FAST                'animal'
              172  LOAD_CONST               None
              174  COMPARE_OP               is
 ...
 L. 313       186  CONTINUE_LOOP        28  'to 28'
            188_0  COME_FROM           184  '184'
            188_1  COME_FROM           148  '148'
            188_2  COME_FROM           128  '128'
            188_3  COME_FROM           110  '110'

 L. 315       188  LOAD_FAST                'home_id'
              190  LOAD_FAST                'animal_data'
              192  STORE_ATTR               home_id

 L. 316       194  LOAD_FAST                'home_data'
              196  LOAD_ATTR                owner_household_id
              198  LOAD_CONST               None
              200  COMPARE_OP               is-not
              202  POP_JUMP_IF_FALSE   212  'to 212'

 L. 317       204  LOAD_FAST                'home_data'
              206  LOAD_ATTR                owner_household_id
              208  LOAD_FAST                'animal_data'
              210  STORE_ATTR               owner_household_id
            212_0  COME_FROM           202  '202'

 L. 318       212  LOAD_FAST                'home_data'
              214  LOAD_ATTR                zone_id
              216  LOAD_CONST               None
              218  COMPARE_OP               is-not
              220  POP_JUMP_IF_FALSE   230  'to 230'

 L. 319       222  LOAD_FAST                'home_data'
              224  LOAD_ATTR                zone_id
              226  LOAD_FAST                'animal_data'
              228  STORE_ATTR               zone_id
            230_0  COME_FROM           220  '220'

 L. 320       230  LOAD_FAST                'home_data'
              232  LOAD_ATTR                open_street_id
              234  LOAD_CONST               None
              236  COMPARE_OP               is-not
              238  POP_JUMP_IF_FALSE   248  'to 248'

 L. 321       240  LOAD_FAST                'home_data'
              242  LOAD_ATTR                open_street_id
              244  LOAD_FAST                'animal_data'
              246  STORE_ATTR               open_street_id
            248_0  COME_FROM           238  '238'
            248_1  COME_FROM            94  '94'
              248  POP_BLOCK        
              250  LOAD_CONST               None
            252_0  COME_FROM_WITH       66  '66'
              252  WITH_CLEANUP_START
              254  WITH_CLEANUP_FINISH
              256  END_FINALLY      
              258  JUMP_LOOP            28  'to 28'
              260  POP_BLOCK        
            262_0  COME_FROM_LOOP       16  '16'

 L. 323       262  LOAD_FAST                'service_data'
              264  LOAD_FAST                'save_slot_data'
              266  LOAD_ATTR                gameplay_data
              268  STORE_ATTR               animal_service

Parse error at or near `CONTINUE_LOOP' instruction at offset 122
    ...
    def on_cleanup_zone_objects(self, client):
        ...
        assignments_to_check = {animal_id: home_data for animal_id, home_data in  if is_home_in_current_zone_or_street(animal_id, home_data)}
        ...
        for animal_id, home_data in assignments_to_check.items():
            ...
            if has_owning_household:
                if home_data.persist_assignment_in_household_inventory:
                    if build_buy.is_household_inventory_available(owner_household_id):
                        if build_buy.object_exists_in_household_inventory(obj_id_to_check, owner_household_id):
                            continue
    ...
    def assign_animal(self, animal_id, home=None):
        ...
        if animal_id not in self._animal_assignment_map:
            if not (animal is None or animal.has_component(ANIMAL_OBJECT_COMPONENT)):
        ...
        for obj_id, destroyed_count in self._objs_destroyed_in_bb.items():
            if (destroyed_count or obj_id) in self._home_ids_registered_in_bb and obj_manager.get(obj_id) is None:
                ...
                if destroyed_count > 0:
                    ...
                    if obj_id in self._registered_homes:
                        del self._registered_homes[obj_id]
    ...
    def _auto_assign_new_inhabitants(self, animal_type, num_assignments_per_home, max_homes_to_assign, tests):
        ...
        def _pick_homes(inner_animal_type, num_homes_to_assign):
            ...
            for animal_home_obj in services.object_manager().get_all_objects_with_component_gen(ANIMAL_HOME_COMPONENT):
                ...
                if inner_animal_type in animal_home_obj.animalhome_component.get_eligible_animal_types():
                    if current_occupancy < animal_home_obj.animalhome_component.get_max_capacity():
