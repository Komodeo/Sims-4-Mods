...
class CustomizableObjectDataList(Op):
 ...
 L.3074         0  LOAD_GLOBAL              super
                2  CALL_FUNCTION_0       0  '0 positional arguments'
                4  LOAD_METHOD              __init__
                6  CALL_METHOD_0         0  '0 positional arguments'
                8  POP_TOP          

 L.3075        10  LOAD_GLOBAL              DistributorOps_pb2
               12  LOAD_METHOD              CustomizableObjectDataList
               14  CALL_METHOD_0         0  '0 positional arguments'
               16  LOAD_FAST                'self'
               18  STORE_ATTR               op

 L.3076        20  BUILD_MAP_0           0 
               22  STORE_FAST               'saved_animal_slots'

 L.3078        24  LOAD_GLOBAL              services
               26  LOAD_METHOD              animal_service
               28  CALL_METHOD_0         0  '0 positional arguments'
               30  STORE_FAST               'animal_service'

 L.3079        32  SETUP_LOOP          266  'to 266'
               34  LOAD_FAST                'objects'
               36  GET_ITER         
             38_0  COME_FROM           262  '262'
             38_1  COME_FROM           196  '196'
             38_2  COME_FROM           160  '160'
               38  FOR_ITER            264  'to 264'
               40  STORE_FAST               'obj'

 L.3080        42  LOAD_FAST                'obj'
               44  LOAD_METHOD              get_attribute_save_data
               46  CALL_METHOD_0         0  '0 positional arguments'
               48  STORE_FAST               'attribute_data'

 L.3081        50  LOAD_GLOBAL              ProtocolBufferRollback
               52  LOAD_FAST                'self'
               54  LOAD_ATTR                op
               56  LOAD_ATTR                object_data
               58  CALL_FUNCTION_1       1  '1 positional argument'
               60  SETUP_WITH          256  'to 256'
               62  STORE_FAST               'object_data'

 L.3082        64  LOAD_FAST                'obj'
               66  LOAD_ATTR                id
               68  LOAD_FAST                'object_data'
               70  STORE_ATTR               object_id

 L.3083        72  LOAD_FAST                'attribute_data'
               74  LOAD_CONST               None
               76  COMPARE_OP               is-not
               78  POP_JUMP_IF_FALSE    90  'to 90'

 L.3084        80  LOAD_FAST                'attribute_data'
               82  LOAD_METHOD              SerializeToString
               84  CALL_METHOD_0         0  '0 positional arguments'
               86  LOAD_FAST                'object_data'
               88  STORE_ATTR               attributes
             90_0  COME_FROM            78  '78'

 L.3085        90  LOAD_FAST                'obj'
               92  LOAD_ATTR                material_variant
               94  LOAD_CONST               None
               96  COMPARE_OP               is-not
               98  POP_JUMP_IF_FALSE   108  'to 108'

 L.3086       100  LOAD_FAST                'obj'
              102  LOAD_ATTR                material_variant
              104  LOAD_FAST                'object_data'
              106  STORE_ATTR               material_variant
            108_0  COME_FROM            98  '98'

 L.3092       108  LOAD_FAST                'obj'
              110  LOAD_METHOD              get_canvas_texture_id
              112  CALL_METHOD_0         0  '0 positional arguments'
              114  STORE_FAST               'texture_id'

 L.3093       116  LOAD_FAST                'texture_id'
              118  LOAD_CONST               None
              120  COMPARE_OP               is-not
              122  POP_JUMP_IF_FALSE   130  'to 130'

 L.3094       124  LOAD_FAST                'texture_id'
              126  LOAD_FAST                'object_data'
              128  STORE_ATTR               texture_id
            130_0  COME_FROM           122  '122'

 L.3095       130  LOAD_FAST                'obj'
              132  LOAD_METHOD              get_canvas_texture_effect
              134  CALL_METHOD_0         0  '0 positional arguments'
              136  STORE_FAST               'texture_effect'

 L.3096       138  LOAD_FAST                'texture_effect'
              140  LOAD_CONST               None
              142  COMPARE_OP               is-not
              144  POP_JUMP_IF_FALSE   152  'to 152'

 L.3097       146  LOAD_FAST                'texture_effect'
              148  LOAD_FAST                'object_data'
              150  STORE_ATTR               texture_effect
            152_0  COME_FROM           144  '144'

 L.3100       152  LOAD_FAST                'animal_service'
              154  LOAD_CONST               None
              156  COMPARE_OP               is
              158  POP_JUMP_IF_FALSE   162  'to 162'

 L.3101       160  CONTINUE_LOOP        38  'to 38'
            162_0  COME_FROM           158  '158'

 L.3103       162  LOAD_FAST                'obj'
              164  LOAD_ATTR                animalobject_component
              166  STORE_FAST               'animal_obj_component'

 L.3104       168  LOAD_FAST                'animal_obj_component'
              170  LOAD_CONST               None
              172  COMPARE_OP               is-not
              174  POP_JUMP_IF_FALSE   252  'to 252'

 L.3105       176  LOAD_FAST                'animal_service'
              178  LOAD_METHOD              get_animal_home_id
              180  LOAD_FAST                'obj'
              182  LOAD_ATTR                id
              184  CALL_METHOD_1         1  '1 positional argument'
              186  STORE_FAST               'home'

 L.3106       188  LOAD_FAST                'home'
              190  LOAD_CONST               None
              192  COMPARE_OP               is
              194  POP_JUMP_IF_FALSE   198  'to 198'

 L.3107       196  CONTINUE_LOOP        38  'to 38'
            198_0  COME_FROM           194  '194'

 L.3109       198  LOAD_FAST                'saved_animal_slots'
              200  LOAD_METHOD              get
              202  LOAD_FAST                'home'
              204  BUILD_LIST_0          0 
              206  CALL_METHOD_2         2  '2 positional arguments'
              208  STORE_FAST               'saved_slots'

 L.3110       210  LOAD_FAST                'animal_obj_component'
              212  LOAD_METHOD              save_animal_assignment_data
              214  LOAD_FAST                'object_data'
              216  LOAD_FAST                'saved_slots'
              218  CALL_METHOD_2         2  '2 positional arguments'
              220  STORE_FAST               'saved'

 L.3111       222  LOAD_FAST                'saved'
              224  POP_JUMP_IF_FALSE   252  'to 252'

 L.3112       226  LOAD_FAST                'object_data'
              228  LOAD_ATTR                parent_id
              230  STORE_FAST               'home'

 L.3113       232  LOAD_FAST                'saved_slots'
              234  LOAD_METHOD              append
              236  LOAD_FAST                'object_data'
              238  LOAD_ATTR                slot_hash
              240  CALL_METHOD_1         1  '1 positional argument'
              242  POP_TOP          

 L.3114       244  LOAD_FAST                'saved_slots'
              246  LOAD_FAST                'saved_animal_slots'
              248  LOAD_FAST                'home'
              250  STORE_SUBSCR     
            252_0  COME_FROM           224  '224'
            252_1  COME_FROM           174  '174'
              252  POP_BLOCK        
              254  LOAD_CONST               None
            256_0  COME_FROM_WITH       60  '60'
              256  WITH_CLEANUP_START
              258  WITH_CLEANUP_FINISH
              260  END_FINALLY      
              262  JUMP_LOOP            38  'to 38'
              264  POP_BLOCK        
            266_0  COME_FROM_LOOP       32  '32'

Parse error at or near `CONTINUE_LOOP' instruction at offset 160
    ...
    def __init__(self, sim_id, followers_count, feed_items, messages_items, is_update=False, has_new_posts=False, has_new_messages=False, can_make_context_post=False, can_add_new_contacts=True):
        ...
        for feed_item in feed_items:
            with ProtocolBufferRollback(self.op.feed_items) as feed_items_msg:
                ...
                if feed_item.target_sim_id is not None:
                    feed_items_msg.target_sim_id = feed_item.target_sim_id if feed_item.target_sim_id >= 0 else 0
