...
class PostureStateSpec(_PostureStateSpec):
    ...
    def get_concrete_version(self, target_resolver, posture_state=None):
        ...
        if posture_state is not None:
            if self.body_target is PostureSpecVariable.ANYTHING or self.body_target is PostureSpecVariable.BODY_TARGET_FILTERED:
        ...
        if posture_manifest:
            ...
            if not slot_manifest or surface_target is not None:
            ...
            if body_target == PostureSpecVariable.ANYTHING and posture_types:
                if surface_target is not None and not isinstance(surface_target, (AnimationParticipant, PostureSpecVariable, str)):
    ...
    def get_posture_specs_gen(self, interaction=None):
        for posture_manifest_entry in self.posture_manifest:
            ...
            if first_list_with_surfaces:
                ...
                if surface_target == PostureSpecVariable.ANYTHING:
                    surface = None
                else:
