...
# Compiled at: 2020-05-05 11:26:11
...
class _WaitForPetsToDespawnState(CommonSituationState):
    ...
    def _get_role_state_overrides(self, sim, job_type, role_state_type, role_affordance_target):
        ...
        return (
         role_state_type, self.owner.pet_crate)
...
class SituationComplexAdoptionPet(SituationComplexAdoption):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _HasFrontDoorArrivalState, factory=(cls.has_front_door_arrival_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.adoption_officer_job_and_role.job, cls.adoption_officer_job_and_role.role_state),
         (
