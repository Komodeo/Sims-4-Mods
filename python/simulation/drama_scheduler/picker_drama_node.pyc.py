        ...
        if self.associated_sim_filter is not None:
            if self._associated_sim_info is None:
                ...
                if results:
                    ...
                    return
        if not run_visibility_tests or owner is not None:
            ...
            if not result:
                ...
                if not (disable_row_if_visibily_tests_fail or self).disable_if_visibility_tests_fail_with_tooltip or tooltip_override:
                    enabled = False
                else:
                    return
