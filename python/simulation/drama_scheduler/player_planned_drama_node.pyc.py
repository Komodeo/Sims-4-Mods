...
class PlayerPlannedDramaNode(BaseDramaNode):
    ...
    def _validate_venue(self):
        ...
        if host_sim_info is not None:
            if self._situation_seed.zone_id == host_sim_info.household.home_zone_id:
                return True
        ...
        for guest_info in self._situation_seed.guest_list.guest_info_gen():
            ...
            if travel_group is not None:
                if self._situation_seed.zone_id == travel_group.zone_id:
                    return True
    ...
    def try_move_special_object_from_hidden(self):
        ...
        if not situation_seed is None:
            if not (situation_seed.special_object_definition_id and situation_seed.host_sim_id):
                return
