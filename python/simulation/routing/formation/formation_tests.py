...
# Compiled at: 2020-11-12 07:43:20
...
class InRoutingFormation(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    def test(self, master, slave, tooltip):
        if slave is not None:
            ...
            if not self.required_or_prohibited:
                if slave.routing_component.routing_master is not None:
            ...
            if master is not None:
                ...
                if self.required_or_prohibited:
                    ...
                    if slave is not None:
                        ...
                        if not ((slave_formation is None or self.formations_to_validate) is not None and self.formations_to_validate.test_item(slave_formation.formation_type)):
