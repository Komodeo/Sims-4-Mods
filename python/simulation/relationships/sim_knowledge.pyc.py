        ...
        if self._knows_career:
            ...
            if target_sim_info is not None:
                if target_sim_info.career_tracker.has_career:
                    careers = tuple((career for career in target_sim_info.careers.values() if career.is_visible_career if not career.is_course_slot if  if not career.is_course_slot))
                    if careers:
                        return careers
