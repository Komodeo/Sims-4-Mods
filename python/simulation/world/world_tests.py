        ...
        for target in test_target:
            ...
            if self.location_tests.is_in_slot is not None:
                ...
                if self.location_tests.is_venue_type is not None:
                    ...
                    if self.location_tests.is_venue_type.negate:
                        if required_venue_tuning is not None:
                            if isinstance(venue, required_venue_tuning):
            ...
            if self.location_tests.has_terrain_tag is not None:
                ...
                if self.location_tests.valid_surface_types is not None:
                    if not (target.routing_surface is None or self.location_tests.valid_surface_types.test_item(target.routing_surface.type)):
                ...
                if self.ownership_test:
                    ...
                    if travel_group is not None:
                        if travel_group.played:
                            if not self.ownership_test.test_type is self.TEST_ANY_OWNERSHIP:
