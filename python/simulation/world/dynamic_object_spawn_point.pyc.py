...
# Compiled at: 2018-01-16 14:36:37
...
class DynamicObjectSpawnPoint(SpawnPoint):
    ...
    def get_position_constraints(self, generalize=False):
        ...
        return [
         interactions.constraints.Circle((self.get_approximate_center()), 2, routing_surface=(self.routing_surface), objects_to_ignore=(set([self.spawn_point_id])))]
