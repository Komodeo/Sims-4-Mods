...
# Compiled at: 2021-03-22 17:29:56
...
class PickTypeTest(HasTunableSingletonFactory, AutoFactoryInit, BaseTest):
    ...
    def __call__(self, context=None):
        ...
        if self.terrain_tags is not None:
            ...
            if self.prohibited_terrain_tags is not None:
                if terrain.is_terrain_tag_at_position((position.x), (position.z), (self.prohibited_terrain_tags), level=(pick_info.routing_surface.secondary_id)):
