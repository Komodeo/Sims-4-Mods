...
# Compiled at: 2020-10-08 12:25:33
...
class PutDownSimInteraction(PutAwayBase):
    ...
    def build_basic_content(self, sequence, **kwargs):
        ...
        sequence = build_critical_section_with_finally(lambda _: change_cancelable_for_target_si(False)
, sequence, lambda _: change_cancelable_for_target_si(target_si_cancelable)
)
        return sequence
