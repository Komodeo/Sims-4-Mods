...
class Commodity(HasTunableReference, TunedContinuousStatistic, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.STATISTIC)):
    ...
    def instance_required(self):
        if not self._buff_handle is not None:
            if self._distress_buff_handle is not None or self.is_visible_commodity():
                return True
            if self.core:
    ...
    def _set_state(self, new_state_index, current_value, apply_state_enter_loot=False, send_client_update=True):
        ...
        if new_state.buff.buff_type:
            if new_state.buff_add_threshold is not None and not self.force_apply_buff_on_start_up:
                self._buff_threshold_callback = new_state.buff_add_threshold.compare(current_value) or self.create_and_add_callback_listener(new_state.buff_add_threshold, self._add_buff_callback)
            else:
    ...
    def set_to_auto_satisfy_value--- This code section failed: ---

 L.1823         0  LOAD_FAST                'self'
                2  LOAD_ATTR                use_autosatisfy_curve
              4_6  POP_JUMP_IF_FALSE   266  'to 266'
                8  LOAD_FAST                'self'
               10  LOAD_ATTR                _auto_satisfy_curve
            12_14  POP_JUMP_IF_FALSE   266  'to 266'

 L.1824        16  LOAD_GLOBAL              services
               18  LOAD_METHOD              time_service
               20  CALL_METHOD_0         0  '0 positional arguments'
               22  LOAD_ATTR                sim_now
               24  STORE_FAST               'now'

 L.1828        26  LOAD_FAST                'self'
               28  LOAD_ATTR                tracker
               30  LOAD_ATTR                owner
               32  LOAD_ATTR                time_sim_was_saved
               34  STORE_FAST               'time_sim_was_saved'

 L.1830        36  LOAD_FAST                'time_sim_was_saved'
               38  LOAD_CONST               None
               40  COMPARE_OP               is
               42  POP_JUMP_IF_FALSE    50  'to 50'
               44  LOAD_FAST                'self'
               46  LOAD_ATTR                use_auto_satisfy_curve_as_initial_value
               48  POP_JUMP_IF_FALSE    58  'to 58'
             50_0  COME_FROM            42  '42'

 L.1831        50  LOAD_FAST                'time_sim_was_saved'
               52  LOAD_FAST                'now'
               54  COMPARE_OP               ==
               56  POP_JUMP_IF_FALSE    62  'to 62'
             58_0  COME_FROM            48  '48'

 L.1832        58  LOAD_CONST               False
               60  RETURN_VALUE     
             62_0  COME_FROM            56  '56'

 L.1836        62  LOAD_GLOBAL              random
               64  LOAD_METHOD              uniform
               66  LOAD_CONST               -1
               68  LOAD_FAST                'self'
               70  LOAD_ATTR                auto_satisfy_curve_random_time_offset
               72  BINARY_MULTIPLY  
               74  LOAD_FAST                'self'
               76  LOAD_ATTR                auto_satisfy_curve_random_time_offset
               78  CALL_METHOD_2         2  '2 positional arguments'
               80  STORE_FAST               'random_time_offset'

 L.1837        82  LOAD_FAST                'now'
               84  LOAD_GLOBAL              interval_in_sim_minutes
               86  LOAD_FAST                'random_time_offset'
               88  CALL_FUNCTION_1       1  '1 positional argument'
               90  INPLACE_ADD      
               92  STORE_FAST               'now'

 L.1840        94  LOAD_FAST                'now'
               96  LOAD_METHOD              hour
               98  CALL_METHOD_0         0  '0 positional arguments'
              100  LOAD_FAST                'now'
              102  LOAD_METHOD              minute
              104  CALL_METHOD_0         0  '0 positional arguments'
              106  LOAD_GLOBAL              date_and_time
              108  LOAD_ATTR                MINUTES_PER_HOUR
              110  BINARY_TRUE_DIVIDE
              112  BINARY_ADD       
              114  STORE_FAST               'current_hour'

 L.1842       116  LOAD_FAST                'self'
              118  LOAD_ATTR                _auto_satisfy_curve
              120  LOAD_METHOD              get
              122  LOAD_FAST                'current_hour'
              124  CALL_METHOD_1         1  '1 positional argument'
              126  STORE_FAST               'auto_satisfy_value'

 L.1843       128  LOAD_GLOBAL              interval_in_sim_minutes
              130  LOAD_FAST                'self'
              132  LOAD_ATTR                maximum_auto_satisfy_time
              134  CALL_FUNCTION_1       1  '1 positional argument'
              136  STORE_FAST               'maximum_auto_satisfy_time'

 L.1850       138  LOAD_FAST                'time_sim_was_saved'
              140  LOAD_CONST               None
              142  COMPARE_OP               is
              144  POP_JUMP_IF_TRUE    158  'to 158'

 L.1851       146  LOAD_FAST                'time_sim_was_saved'
              148  LOAD_FAST                'maximum_auto_satisfy_time'
              150  BINARY_ADD       
              152  LOAD_FAST                'now'
              154  COMPARE_OP               <=
 ...
 L.1852       158  LOAD_GLOBAL              services
              160  LOAD_METHOD              time_service
              162  CALL_METHOD_0         0  '0 positional arguments'
              164  LOAD_ATTR                sim_now
              166  LOAD_FAST                'self'
              168  STORE_ATTR               _last_update

 L.1853       170  LOAD_FAST                'self'
              172  LOAD_METHOD              set_user_value
              174  LOAD_FAST                'auto_satisfy_value'
              176  CALL_METHOD_1         1  '1 positional argument'
              178  POP_TOP          

 L.1854       180  LOAD_CONST               True
              182  RETURN_VALUE     
            184_0  COME_FROM           156  '156'

 L.1859       184  LOAD_FAST                'time_sim_was_saved'
              186  LOAD_FAST                'now'
              188  COMPARE_OP               >=
              190  POP_JUMP_IF_FALSE   196  'to 196'

 L.1860       192  LOAD_CONST               False
              194  RETURN_VALUE     
            196_0  COME_FROM           190  '190'

 L.1864       196  LOAD_FAST                'now'
              198  LOAD_FAST                'time_sim_was_saved'
              200  BINARY_SUBTRACT  
              202  LOAD_METHOD              in_ticks
              204  CALL_METHOD_0         0  '0 positional arguments'
              206  LOAD_FAST                'maximum_auto_satisfy_time'
              208  LOAD_METHOD              in_ticks
              210  CALL_METHOD_0         0  '0 positional arguments'
              212  BINARY_TRUE_DIVIDE
              214  STORE_FAST               'interpolation_time'

 L.1865       216  LOAD_FAST                'self'
              218  LOAD_METHOD              get_user_value
              220  CALL_METHOD_0         0  '0 positional arguments'
              222  STORE_FAST               'current_value'

 L.1867       224  LOAD_FAST                'auto_satisfy_value'
              226  LOAD_FAST                'current_value'
              228  BINARY_SUBTRACT  
              230  LOAD_FAST                'interpolation_time'
              232  BINARY_MULTIPLY  
              234  LOAD_FAST                'current_value'
              236  BINARY_ADD       
              238  STORE_FAST               'new_value'

 L.1869       240  LOAD_GLOBAL              services
              242  LOAD_METHOD              time_service
              244  CALL_METHOD_0         0  '0 positional arguments'
              246  LOAD_ATTR                sim_now
              248  LOAD_FAST                'self'
              250  STORE_ATTR               _last_update

 L.1870       252  LOAD_FAST                'self'
              254  LOAD_METHOD              set_user_value
              256  LOAD_FAST                'new_value'
              258  CALL_METHOD_1         1  '1 positional argument'
              260  POP_TOP          

 L.1871       262  LOAD_CONST               True
              264  RETURN_VALUE     
            266_0  COME_FROM            12  '12'
            266_1  COME_FROM             4  '4'

 L.1873       266  LOAD_CONST               False
              268  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `LOAD_GLOBAL' instruction at offset 62
    ...
    def is_visible_commodity(self):
        if not (self.tracker is None or self.tracker.owner.is_sim):
            return False
        if not self.visible:
            return False
