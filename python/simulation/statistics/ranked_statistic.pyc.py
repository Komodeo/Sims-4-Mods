...
class RankedStatistic(HasTunableReference, ProgressiveStatisticCallbackMixin, statistics.continuous_statistic_tuning.TunedContinuousStatistic, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.STATISTIC)):
 ...
 L. 546         0  LOAD_FAST                'cls'
                2  LOAD_ATTR                initial_value
                4  STORE_FAST               'initial_value'

 L. 547         6  LOAD_CONST               1
                8  STORE_FAST               'starting_rank'

 L. 548        10  LOAD_CONST               0
               12  STORE_FAST               'point_value'

 L. 549        14  SETUP_LOOP          102  'to 102'
               16  LOAD_GLOBAL              enumerate
               18  LOAD_FAST                'cls'
               20  LOAD_METHOD              get_level_list
               22  CALL_METHOD_0         0  '0 positional arguments'
               24  CALL_FUNCTION_1       1  '1 positional argument'
               26  GET_ITER         
             28_0  COME_FROM            98  '98'
             28_1  COME_FROM            88  '88'
               28  FOR_ITER            100  'to 100'
               30  UNPACK_SEQUENCE_2     2 
               32  STORE_FAST               'level'
               34  STORE_FAST               'level_threshold'

 L. 550        36  LOAD_FAST                'level'
               38  LOAD_CONST               1
               40  INPLACE_ADD      
               42  STORE_FAST               'level'

 L. 551        44  LOAD_FAST                'point_value'
               46  LOAD_FAST                'level_threshold'
               48  INPLACE_ADD      
               50  STORE_FAST               'point_value'

 L. 553        52  LOAD_FAST                'point_value'
               54  LOAD_FAST                'initial_value'
               56  COMPARE_OP               >
               58  POP_JUMP_IF_TRUE     76  'to 76'
               60  LOAD_FAST                'point_value'
               62  LOAD_FAST                'initial_value'
               64  COMPARE_OP               ==
               66  POP_JUMP_IF_FALSE    78  'to 78'
               68  LOAD_FAST                'level_threshold'
               70  LOAD_CONST               0
               72  COMPARE_OP               ==
 ...
 L. 554        76  BREAK_LOOP       
             ...
             78_1  COME_FROM            66  '66'

 L. 555        78  LOAD_FAST                'cls'
               80  LOAD_ATTR                event_data
               82  LOAD_FAST                'level'
               84  BINARY_SUBSCR    
               86  LOAD_ATTR                rank_up
               88  POP_JUMP_IF_FALSE_LOOP    28  'to 28'

 L. 556        90  LOAD_FAST                'starting_rank'
               92  LOAD_CONST               1
               94  INPLACE_ADD      
               96  STORE_FAST               'starting_rank'
               98  JUMP_LOOP            28  'to 28'
              100  POP_BLOCK        
            102_0  COME_FROM_LOOP       14  '14'

 L. 557       102  LOAD_FAST                'cls'
              104  LOAD_ATTR                starting_rank_display_value
              106  LOAD_FAST                'starting_rank'
              108  COMPARE_OP               !=
              110  POP_JUMP_IF_FALSE   132  'to 132'

 L. 560       112  LOAD_GLOBAL              logger
              114  LOAD_METHOD              error
              116  LOAD_STR                 " {}: 'starting_rank_display_value' is {} and should be {}."
              118  LOAD_FAST                'cls'
              120  LOAD_ATTR                __name__
              122  LOAD_FAST                'cls'
              124  LOAD_ATTR                starting_rank_display_value
              126  LOAD_FAST                'starting_rank'
              128  CALL_METHOD_4         4  '4 positional arguments'
              130  POP_TOP          
            132_0  COME_FROM           110  '110'

Parse error at or near `COME_FROM_LOOP' instruction at offset 102_0
    ...
    def _on_rank_up(self, new_rank=True, from_add=False):
        ...
        if not from_add or self.display_updates_from_add:
        ...
        if not from_add:
            if sim_info.is_selectable:
                if rank_up_data is not None:
                    if self.can_show_notification(rank_up_data):
        ...
        while old_level < new_level:
            ...
            if event_data is not None:
                if self.tracker.owner.is_simulating:
                    ...
                    if event_data.rank_up:
                        batch_rank_levels += 1
            if not (self.tracker.owner.is_npc and from_add):
    ...
    def can_show_notification(self, rank_data):
        if self._notifications_disabled:
            return False
        if not rank_data is not None or rank_data.show_notification_tests is not None:
