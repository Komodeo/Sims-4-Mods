...
# Compiled at: 2021-05-17 15:19:04
...
class RestaurantDinerBackGroundSituation(SituationComplexCommon):
    ...
    def start_situation(self):
        ...
        super().start_situation()
        reader = self._seed.custom_init_params_reader
        if not self.allow_preroll or reader is None:
    ...
    def _check_modify_lot_owed_payment(self, add_payment=True):
        ...
        player_sim_ids = (sim.sim_id for sim in self.all_sims_in_situation_gen() if not sim.is_npc if  if not sim.is_npc)
