...
# Size of source mod 2**32: 76080 bytes
...
class Scenario(metaclass=sims4.tuning.instances.HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.SNIPPET)):
    ...
    def apply_loot--- This code section failed: ---

 L.1171         0  LOAD_CLOSURE             'loot_tuple'
                2  LOAD_CLOSURE             'self'
                4  BUILD_TUPLE_2         2 
                6  LOAD_CODE                <code_object apply_double_sim_loot>
                8  LOAD_STR                 'Scenario.apply_loot.<locals>.apply_double_sim_loot'
               10  MAKE_FUNCTION_CLOSURE        'closure'
               12  STORE_DEREF              'apply_double_sim_loot'

 L.1179        14  LOAD_CLOSURE             'apply_double_sim_loot'
               16  LOAD_CLOSURE             'self'
               18  BUILD_TUPLE_2         2 
               20  LOAD_CODE                <code_object check_and_apply_single_or_double_sim_loot>
               22  LOAD_STR                 'Scenario.apply_loot.<locals>.check_and_apply_single_or_double_sim_loot'
               24  MAKE_FUNCTION_CLOSURE        'closure'
               26  STORE_FAST               'check_and_apply_single_or_double_sim_loot'

 L.1198        28  SETUP_LOOP          172  'to 172'
               30  LOAD_FAST                'loots'
               32  GET_ITER         
             34_0  COME_FROM           168  '168'
             34_1  COME_FROM           144  '144'
             34_2  COME_FROM            94  '94'
               34  FOR_ITER            170  'to 170'
               36  STORE_DEREF              'loot_tuple'

 L.1199        38  LOAD_DEREF               'loot_tuple'
               40  LOAD_ATTR                scenario_loot
               42  LOAD_ATTR                actor_role
               44  STORE_FAST               'actor_role'

 L.1200        46  LOAD_DEREF               'loot_tuple'
               48  LOAD_ATTR                scenario_loot
               50  LOAD_ATTR                actor_sim_filter
               52  STORE_FAST               'actor_sim_filter'

 L.1201        54  LOAD_FAST                'actor_role'
               56  LOAD_CONST               None
               58  COMPARE_OP               is-not
               60  POP_JUMP_IF_FALSE    96  'to 96'

 L.1202        62  SETUP_LOOP          168  'to 168'
               64  LOAD_DEREF               'self'
               66  LOAD_METHOD              sim_infos_of_interest_gen
               68  LOAD_FAST                'actor_role'
               70  BUILD_LIST_1          1 
               72  CALL_METHOD_1         1  '1 positional argument'
               74  GET_ITER         
             76_0  COME_FROM            90  '90'
               76  FOR_ITER             92  'to 92'
               78  STORE_FAST               'sim_info'

 L.1203        80  LOAD_FAST                'check_and_apply_single_or_double_sim_loot'
               82  LOAD_FAST                'sim_info'
               84  LOAD_DEREF               'loot_tuple'
               86  CALL_FUNCTION_2       2  '2 positional arguments'
               88  POP_TOP          
               90  JUMP_LOOP            76  'to 76'
               92  POP_BLOCK        
               94  JUMP_LOOP            34  'to 34'
             96_0  COME_FROM            60  '60'

 L.1204        96  LOAD_FAST                'actor_sim_filter'
               98  LOAD_CONST               None
              100  COMPARE_OP               is-not
              102  POP_JUMP_IF_FALSE   146  'to 146'

 L.1205       104  LOAD_DEREF               'self'
              106  LOAD_METHOD              get_sim_info_from_sim_filter
              108  LOAD_FAST                'actor_sim_filter'
              110  CALL_METHOD_1         1  '1 positional argument'
              112  STORE_FAST               'sim_info'

 L.1206       114  LOAD_FAST                'sim_info'
              116  LOAD_CONST               None
              118  COMPARE_OP               is-not
              120  POP_JUMP_IF_FALSE   134  'to 134'

 L.1207       122  LOAD_FAST                'check_and_apply_single_or_double_sim_loot'
              124  LOAD_FAST                'sim_info'
              126  LOAD_DEREF               'loot_tuple'
              128  CALL_FUNCTION_2       2  '2 positional arguments'
              130  POP_TOP          
              132  JUMP_FORWARD        168  'to 168'
            134_0  COME_FROM           120  '120'

 L.1209       134  LOAD_GLOBAL              logger
              136  LOAD_METHOD              error
              138  LOAD_STR                 'No sim satisfying actor_sim_filter conditions is found.'
              140  CALL_METHOD_1         1  '1 positional argument'
              142  POP_TOP          
              144  JUMP_LOOP            34  'to 34'
            146_0  COME_FROM           102  '102'

 L.1211       146  LOAD_DEREF               'loot_tuple'
              148  LOAD_ATTR                scenario_loot
              150  LOAD_ATTR                loot_action
              152  LOAD_METHOD              apply_to_resolver
              154  LOAD_GLOBAL              GlobalResolver
              156  LOAD_DEREF               'self'
              158  LOAD_ATTR                _active_phase
              160  LOAD_CONST               ('additional_metric_key_data',)
            ...
            168_1  COME_FROM_LOOP       62  '62'
              168  JUMP_LOOP            34  'to 34'
              170  POP_BLOCK        
            172_0  COME_FROM_LOOP       28  '28'

Parse error at or near `COME_FROM_LOOP' instruction at offset 168_1
    ...
    def load_data_without_phase(self, gameplay_scenario_data_msg, to_goal):
        ...
        for goal_tuning in self.goals:
            if goal_tuning.situation_goal is not None:
                if goal_tuning.situation_goal.guid64 not in goal_ids:
        ...
        for goal_sequence_tuple in phase.goals:
            ...
            for goal_tuple in goal_sequence_tuple.goal_sequence:
                ...
                if goal_id in active_goal_ids:
                    ...
                    if self.is_goal_completed(goal_id):
                        new_goal_candidate = None
                if new_goal_candidate is None:
                    if goal_id not in active_goal_ids:
                        if not self.is_goal_completed(goal_id):
            ...
            if new_goal_candidate is not None:
                ...
                self._active_goals.append(ActiveGoal(goal, new_goal_candidate.goal))
    ...
    def _on_goal_completed(self, goal, is_completed):
        ...
        if self.starting_phase is None:
            ...
            if is_completed and self._active_phase is not None:
                ...
                if not self.is_there_mandatory_active_goals() or self._active_phase is not None:
            ...
            if next_goal_in_sequence_found:
                ...
                for index, phase_goal in enumerate(goal_tuple.goal_sequence):
                    if phase_goal.goal.situation_goal.guid64 == completed_goal.guid64:
                        ...
                        elif len(goal_tuple.goal_sequence) > index + 1:
