...
# Compiled at: 2020-06-23 20:07:00
...
class StreetService(Service, BaseCivicPolicyProviderServiceMixin):
    ...
    def get_neighborhood_proto(self, street, add=True):
        ...
        return (
         neighborhood_proto, neighborhood_proto.street_data[-1])
    ...
    def _get_active_household_provider(self):
        ...
        if not active_sim is None:
            if active_sim.household is None or active_sim.household.home_zone_id == 0:
                return
