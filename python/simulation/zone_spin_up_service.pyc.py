...
# Compiled at: 2022-07-28 19:35:21
            ...
            if sim_info.is_selectable:
                ...
                if travel_group is not None:
                    if travel_group.zone_id == 0:
                        ...
                        if travel_group.zone_id not in loaded_zones:
...
class _SetActiveSimState(_ZoneSpinUpState):
    ...
    def on_enter(self):
        ...
        client = zone_spin_up_service._client_connect_data.client
        if active_sim_id and not client.set_active_sim_by_id(active_sim_id, consider_active_sim=False):
