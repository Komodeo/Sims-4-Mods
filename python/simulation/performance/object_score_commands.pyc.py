...
# Compiled at: 2021-04-28 13:15:43
...
def dump_object_scores(use_raw_score=False, _connection=None):
    ...
    def _score_objects_callback(file, verbose=False):
        ...
        if verbose:
            ...
            file.write('\n')
        sorted_object_scores = sorted(object_scores, key=(lambda obj: sum(object_scores[obj].values())
), reverse=True)
    ...
    create_csv('object_scores_verbose', lambda new_file: _score_objects_callback(new_file, verbose=True)
, _connection)
