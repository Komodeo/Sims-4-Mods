...
class RelbitPickerSuperInteraction(PickerSuperInteraction):
        ...
        if cls.is_add:
            for bit in bit_manager.types.values():
                if not bit.is_collection:
                    if not rel_tracker.has_bit(target_sim_id, bit):
                        yield bit
 ...
 L. 506         0  SETUP_LOOP           80  'to 80'
                2  LOAD_FAST                'cls'
                4  LOAD_METHOD              _bit_selection_gen
                6  LOAD_FAST                'target'
                8  LOAD_FAST                'context'
               10  CALL_METHOD_2         2  '2 positional arguments'
               12  GET_ITER         
             14_0  COME_FROM            76  '76'
             14_1  COME_FROM            40  '40'
             14_2  COME_FROM            22  '22'
               14  FOR_ITER             78  'to 78'
               16  STORE_FAST               'bit'

 L. 507        18  LOAD_FAST                'bit'
               20  LOAD_ATTR                display_name
               22  POP_JUMP_IF_FALSE_LOOP    14  'to 14'

 L. 508        24  LOAD_FAST                'bit'
               26  LOAD_METHOD              display_name
               28  LOAD_FAST                'context'
               30  LOAD_ATTR                sim
               32  LOAD_FAST                'target'
               34  CALL_METHOD_2         2  '2 positional arguments'
               36  STORE_FAST               'display_name'
               38  JUMP_FORWARD         42  'to 42'

 L. 513        40  CONTINUE             14  'to 14'
             42_0  COME_FROM            38  '38'

 L. 515        42  LOAD_GLOBAL              ObjectPickerRow

 L. 516        44  LOAD_FAST                'display_name'

 L. 517        46  LOAD_FAST                'bit'
               48  LOAD_ATTR                icon

 L. 518        50  LOAD_FAST                'bit'
               52  LOAD_METHOD              bit_description
               54  LOAD_FAST                'context'
               56  LOAD_ATTR                sim
               58  LOAD_FAST                'target'
               60  CALL_METHOD_2         2  '2 positional arguments'

 L. 519        62  LOAD_FAST                'bit'
               64  LOAD_CONST               ('name', 'icon', 'row_description', 'tag')
               66  CALL_FUNCTION_KW_4     4  '4 total positional and keyword args'
               68  STORE_FAST               'row'

 L. 520        70  LOAD_FAST                'row'
               72  YIELD_VALUE      
               74  POP_TOP          
               76  JUMP_LOOP            14  'to 14'
               78  POP_BLOCK        
             80_0  COME_FROM_LOOP        0  '0'

Parse error at or near `CONTINUE' instruction at offset 40
