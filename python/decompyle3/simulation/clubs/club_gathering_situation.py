...
# Compiled at: 2020-11-13 12:39:19
...
class ClubGatheringSituation(SituationComplexCommon):
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.default_job(), cls._default_role_state)]

    @classmethod
    def _states(cls):
        return (
         SituationStateData(1, ClubGatheringSituationState),)
...
class ClubGatheringSituationState(SituationState):
    ...
    def handle_event(self, _, event, resolver):
        ...
        if interaction_rule_status[ClubRuleEncouragementStatus.DISCOURAGED]:
            ...
            if interaction_rule_status[ClubRuleEncouragementStatus.ENCOURAGED]:
