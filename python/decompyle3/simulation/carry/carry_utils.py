...
def holster_objects_for_route(sim, unholster_after_predicate=lambda _: False
, sequence=None):
...
def maybe_holster_objects_through_sequence(sim, predicate=lambda _: True
, unholster_after_predicate=lambda _: True
, sequence=None):
...
def unholster_object(carry_posture, flush_before_sequence=False, sequence=None):
    ...
    return build_critical_section(interact_with_carried_object((carry_posture.sim), carry_object, animation_context=(carry_posture.asm.context),
      ...
      must_run=True,
      sequence=(build_critical_section(unholster, lambda _: _set_unholster()
