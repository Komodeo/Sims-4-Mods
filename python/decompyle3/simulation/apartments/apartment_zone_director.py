...
# Compiled at: 2018-07-17 11:14:46
...
class ApartmentZoneDirectorMixin(SchedulingZoneDirectorMixin):
    ...
    def on_startup(self):
        ...
        handle = add_alarm(self, time_span, (lambda _: self._run_common_area_cleanup()
), repeating=True,
...
class ApartmentZoneDirectorPlayer(ApartmentZoneDirectorMixin, ZoneDirectorResidentialPlayer):
    ...
    def _load_custom_zone_director(self, zone_director_proto, reader):
        if reader is not None:
            ...
            self._aspiration_timeouts = {aspiration_manager.get(aspiration_id): DateAndTime(timeout) for aspiration_id, timeout in }
