...
# Compiled at: 2016-08-30 10:26:43
...
class LandlordSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _FixProblemsState, factory=(cls.fix_problems_state)),)
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.landlord_situation_job_and_role_state.job, cls.landlord_situation_job_and_role_state.role_state)]
