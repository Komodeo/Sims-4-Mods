...
# Compiled at: 2018-09-07 15:25:33
...
class GreetedPlayerVisitingNPCSituation(VisitingNPCSituation):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _GreetedPlayerVisitingNPCState, factory=(cls.greeted_player_visiting_npc_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.greeted_player_sims.situation_job, cls.greeted_player_sims.role_state)]
