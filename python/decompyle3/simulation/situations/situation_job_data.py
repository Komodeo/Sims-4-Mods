...
# Compiled at: 2018-10-23 15:29:17
...
class SituationJobData:
    ...
    def _get_churn(self):
        if not (self._job_type.churn is None or self._job_type.churn.auto_populate_by_time_of_day):
            return
        return self._job_type.churn

    def _get_shifts(self):
        if not (self._job_type.sim_shifts is None or self._job_type.sim_shifts.shift_times_and_staffing):
            return
