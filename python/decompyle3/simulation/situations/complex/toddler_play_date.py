...
# Compiled at: 2019-11-13 16:00:31
...
class ToddlerPlayDateSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _PlayDateState, factory=(cls._play_date_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.host_toddler_job_and_role_state.job, cls.host_toddler_job_and_role_state.role_state),
         (
    ...
    def _add_guest_parent_to_guest_list(cls, guest_list):
        ...
        households = {m.get(sim.sim_id).household for sim in }
