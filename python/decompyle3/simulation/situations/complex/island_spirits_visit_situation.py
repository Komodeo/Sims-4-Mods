...
# Compiled at: 2019-02-21 13:56:30
...
class IslandSpiritsVisitSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData.from_auto_factory(1, cls.visit_state),)

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.island_elemental.situation_job, cls.island_elemental.situation_role_state),
         (
