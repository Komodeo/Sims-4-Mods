...
# Compiled at: 2020-09-21 20:59:03
...
class WaitInLineTogether(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, GetSimsState),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.waiting_in_line_sim_job_and_role_state.job, cls.waiting_in_line_sim_job_and_role_state.role_state),
         (
    ...
    def _on_routing_formation_started(self, slave=None):
        if not self.is_sim_in_situation(slave) or slave is None:
            return
