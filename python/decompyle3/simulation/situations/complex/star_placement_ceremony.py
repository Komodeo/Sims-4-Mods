...
# Compiled at: 2018-07-25 17:13:07
...
class StarPlacementCeremonySituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _GatherState, factory=(cls.gather_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.honoree_job_and_role_state.job, cls.honoree_job_and_role_state.role_state),
         (
