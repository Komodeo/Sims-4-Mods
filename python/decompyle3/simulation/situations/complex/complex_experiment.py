...
# Compiled at: 2016-10-20 16:42:24
...
class SituationComplexExperiment(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, AngrySituationState),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.test_job.situation_job, cls.test_job.friendly_role_state), (cls._host_job.situation_job, cls._host_job.default_role_state)]
