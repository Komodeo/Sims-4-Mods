...
# Compiled at: 2020-07-30 18:33:13
...
class PrisonerEscortSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _EscortState, factory=(cls.escort_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.escort_job_and_role_state.job, cls.escort_job_and_role_state.role_state),
         (
    ...
    def start_situation(self):
        ...
        if not escort_sim is not None or prisoner_sim is not None:
            if escort_sim.sim_info.is_npc and not prisoner_sim.sim_info.is_npc:
