...
# Compiled at: 2020-05-15 13:59:30
...
class StormtrooperInspectionSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _FleeState, factory=(cls.flee_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.suspect_job_and_role_state.job, cls.suspect_job_and_role_state.role_state),
         (
