...
class StrangePreWelcomeWagon(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, HasFrontDoorStrangeSituationStartingState, factory=(cls.has_front_door_situation_starting_state)),
...
class StrangeWelcomeWagon(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, WaitToInfectSituationState, factory=(cls.wait_to_infect_state)),
...
class StrangePostWelcomeWagon(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData.from_auto_factory(0, cls.delay_state),
