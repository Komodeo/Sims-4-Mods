...
# Compiled at: 2016-09-01 15:51:12
...
class YardSaleSituation(SituationComplexCommon):
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.user_job.situation_job, cls.user_job.role_state)]

    @classmethod
    def _states(cls):
        return (
         SituationStateData(1, ManageCustomersState, factory=(cls.manage_customers_state)),)
