...
class _MatchingFilterRequest(_SimFilterRequest):
 ...
 L. 374        24  SETUP_LOOP          138  'to 138'
               ...
               32  GET_ITER         
             34_0  COME_FROM           134  '134'
             34_1  COME_FROM           122  '122'
             34_2  COME_FROM           108  '108'
             34_3  COME_FROM            92  '92'
 ...
 L. 380        84  LOAD_FAST                'self'
               ...
               92  POP_JUMP_IF_FALSE_LOOP    34  'to 34'
 ...
 L. 381        94  LOAD_FAST                'sim_info'
              ...
              108  POP_JUMP_IF_TRUE_LOOP    34  'to 34'
 ...
 L. 382       110  LOAD_FAST                'sim_info'
              ...
              122  POP_JUMP_IF_TRUE_LOOP    34  'to 34'
...
Parse error at or near `LOAD_FAST' instruction at offset 124
    ...
    def _run_filter_query(self):
        ...
        if constrained_sim_ids is not None:
            ...
            if not (len(self._filter_results) == self._number_of_sims_to_find or self._continue_if_constraints_fail):
                return self._filter_results
