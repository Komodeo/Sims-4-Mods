...
# Compiled at: 2020-11-19 17:00:28
...
class GameComponent(Component, HasTunableFactory, component_name=types.GAME_COMPONENT, persistence_key=protocols.PersistenceMaster.PersistableData.GameComponent):
    ...
    def _generate_active_sims(self):
        ...
        return (
         temporary_active_sims, next_player)
    ...
    def end_game(self):
        ...
        if not self.target_object is not None or self.target_object is not self.owner:
...
class TunableSetGameTarget(TunableFactory):
    ...
    def factory(interaction, sequence=()):
        ...
        sequence = build_critical_section_with_finally(lambda _: set_new_target()
, sequence, lambda _: revert_target()
)
        return sequence
