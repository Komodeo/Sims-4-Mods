...
# Compiled at: 2019-07-11 11:01:21
...
class DynamicInteractionSpawnPoint(SpawnPoint):
    ...
    def __init__(self, interaction, participant_type, distance_to_participant, tag_set, lot_id, zone_id, allow_spawning_on_non_world_routing_surfaces):
        ...
        if not participant is not None or participant.routing_surface.type == routing.SurfaceType.SURFACETYPE_WORLD or allow_spawning_on_non_world_routing_surfaces:
    ...
    def get_position_constraints(self, generalize=False):
        trans = self._get_pos()
        return [
         interactions.constraints.Position(trans, routing_surface=(self.routing_surface), objects_to_ignore=(set([self.spawn_point_id])))]
