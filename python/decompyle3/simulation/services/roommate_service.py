...
# Compiled at: 2021-06-09 13:34:41
...
class RoommateService(Service):
    ...
    def load(self, **_):
        ...
        if roommate_service_data.HasField('ad_info'):
            ...
            for alarm_tick in roommate_service_data.ad_info.pending_interview_alarms:
                handle = alarms.add_alarm(self, (TimeSpan(alarm_tick)), (lambda _: self._trigger_interview()
), cross_zone=True)
    ...
    def trigger_interviews(self, enabled, show_tns=False):
        if enabled:
            ...
            self._interview_schedule_alarm = alarms.add_alarm(self, time_span, (lambda _: self._schedule_interviews()
), repeating=True,
    ...
    def _update_leave_reason_testing_time(self, sim_data, sim_id, testing_time, evict):
        ...
        for leave_reason in LEAVE_REASONS[testing_time]:
            ...
            if leave_data.tests is None:
                ...
                if leave_data.tests.tests.run_tests(resolver):
                    if evict:
 ...
 L.1007         0  LOAD_FAST                'self'
                2  LOAD_ATTR                _zone_to_roommates
                4  POP_JUMP_IF_TRUE     10  'to 10'

 L.1008         6  LOAD_CONST               None
                8  RETURN_VALUE     
             10_0  COME_FROM             4  '4'

 L.1010        10  LOAD_GLOBAL              services
               12  LOAD_METHOD              active_household
               14  CALL_METHOD_0         0  '0 positional arguments'
               16  LOAD_CONST               None
               18  COMPARE_OP               is
               20  POP_JUMP_IF_FALSE    26  'to 26'

 L.1011        22  LOAD_CONST               None
               24  RETURN_VALUE     
             26_0  COME_FROM            20  '20'

 L.1014        26  LOAD_FAST                'zone_id'
               28  LOAD_FAST                'self'
               30  LOAD_ATTR                _zone_to_roommates
               32  COMPARE_OP               in
            34_36  POP_JUMP_IF_FALSE   384  'to 384'

 L.1015        38  LOAD_FAST                'self'
               40  LOAD_ATTR                _zone_to_roommates
               42  LOAD_FAST                'zone_id'
               44  BINARY_SUBSCR    
               46  STORE_FAST               'household_roommate_data'

 L.1016        48  LOAD_GLOBAL              len
               50  LOAD_FAST                'household_roommate_data'
               52  LOAD_ATTR                sim_ids
               54  CALL_FUNCTION_1       1  '1 positional argument'
               56  STORE_FAST               'total_sims'

 L.1017        58  LOAD_FAST                'self'
               60  LOAD_METHOD              _get_household_from_zone_id
               62  LOAD_FAST                'zone_id'
               64  CALL_METHOD_1         1  '1 positional argument'
               66  STORE_FAST               'household'

 L.1018        68  LOAD_FAST                'self'
               70  LOAD_ATTR                UNPLAYED_HOUSEHOLD_AND_ROOMMATE_CAP
               72  STORE_FAST               'available_roommate_space'

 L.1019        74  LOAD_FAST                'household'
               76  LOAD_CONST               None
               78  COMPARE_OP               is-not
               80  POP_JUMP_IF_FALSE   106  'to 106'

 L.1020        82  LOAD_FAST                'total_sims'
               84  LOAD_GLOBAL              len
               86  LOAD_FAST                'household'
               88  CALL_FUNCTION_1       1  '1 positional argument'
               90  INPLACE_ADD      
               92  STORE_FAST               'total_sims'

 L.1021        94  LOAD_FAST                'household'
               96  LOAD_ATTR                is_played_household
               98  POP_JUMP_IF_FALSE   106  'to 106'

 L.1022       100  LOAD_FAST                'self'
              102  LOAD_ATTR                HOUSEHOLD_AND_ROOMMATE_CAP
              104  STORE_FAST               'available_roommate_space'
            106_0  COME_FROM            98  '98'
            106_1  COME_FROM            80  '80'

 L.1023       106  LOAD_FAST                'available_roommate_space'
              108  LOAD_FAST                'total_sims'
              110  INPLACE_SUBTRACT 
              112  STORE_FAST               'available_roommate_space'

 L.1025       114  BUILD_LIST_0          0 
              116  STORE_FAST               'leaving_roommates'

 L.1026       118  LOAD_CONST               0
              120  STORE_FAST               'leaving_roommate_count'

 L.1027       122  BUILD_LIST_0          0 
              124  STORE_FAST               'available_roommates'

 L.1028       126  SETUP_LOOP          192  'to 192'
              128  LOAD_FAST                'household_roommate_data'
              130  LOAD_ATTR                sim_datas
              132  LOAD_METHOD              items
              134  CALL_METHOD_0         0  '0 positional arguments'
              136  GET_ITER         
            138_0  COME_FROM           188  '188'
            138_1  COME_FROM           176  '176'
              138  FOR_ITER            190  'to 190'
              140  UNPACK_SEQUENCE_2     2 
              142  STORE_FAST               'sim_id'
              144  STORE_FAST               'sim_data'

 L.1029       146  LOAD_GLOBAL              RoommateLeaveReason
              148  LOAD_ATTR                OVERCAPACITY
              150  LOAD_FAST                'sim_data'
              152  LOAD_ATTR                leave_reasons
              154  COMPARE_OP               in
              156  POP_JUMP_IF_FALSE   178  'to 178'

 L.1030       158  LOAD_FAST                'leaving_roommates'
              160  LOAD_METHOD              append
              162  LOAD_FAST                'sim_id'
              164  CALL_METHOD_1         1  '1 positional argument'
              166  POP_TOP          

 L.1031       168  LOAD_FAST                'leaving_roommate_count'
              170  LOAD_CONST               1
              172  INPLACE_ADD      
              174  STORE_FAST               'leaving_roommate_count'
              176  JUMP_LOOP           138  'to 138'
            178_0  COME_FROM           156  '156'

 L.1033       178  LOAD_FAST                'available_roommates'
              180  LOAD_METHOD              append
              182  LOAD_FAST                'sim_id'
              184  CALL_METHOD_1         1  '1 positional argument'
              186  POP_TOP          
              188  JUMP_LOOP           138  'to 138'
              190  POP_BLOCK        
            192_0  COME_FROM_LOOP      126  '126'

 L.1035       192  LOAD_FAST                'available_roommate_space'
              194  LOAD_FAST                'leaving_roommate_count'
              196  BINARY_ADD       
              198  LOAD_CONST               0
              200  COMPARE_OP               <
          202_204  POP_JUMP_IF_FALSE   290  'to 290'

 L.1036       206  LOAD_FAST                'available_roommates'
          208_210  POP_JUMP_IF_FALSE   384  'to 384'

 L.1037       212  LOAD_GLOBAL              services
              214  LOAD_METHOD              sim_info_manager
              216  CALL_METHOD_0         0  '0 positional arguments'
              218  STORE_FAST               'sim_info_manager'

 L.1038       220  LOAD_GLOBAL              random
              222  LOAD_METHOD              shuffle
              224  LOAD_FAST                'available_roommates'
              226  CALL_METHOD_1         1  '1 positional argument'
              228  POP_TOP          

 L.1039       230  SETUP_LOOP          384  'to 384'
              232  LOAD_GLOBAL              range
              234  LOAD_FAST                'available_roommate_space'
              236  LOAD_FAST                'leaving_roommate_count'
              238  BINARY_ADD       
              240  UNARY_NEGATIVE   
              242  CALL_FUNCTION_1       1  '1 positional argument'
              244  GET_ITER         
            246_0  COME_FROM           284  '284'
            246_1  COME_FROM           280  '280'
              246  FOR_ITER            286  'to 286'
              248  STORE_FAST               '_'

 L.1040       250  LOAD_FAST                'sim_info_manager'
              252  LOAD_METHOD              get
              254  LOAD_FAST                'available_roommates'
              256  LOAD_METHOD              pop
              258  CALL_METHOD_0         0  '0 positional arguments'
              260  CALL_METHOD_1         1  '1 positional argument'
              262  STORE_FAST               'sim_info'

 L.1041       264  LOAD_FAST                'self'
              266  LOAD_METHOD              add_leave_reason
              268  LOAD_FAST                'sim_info'
              270  LOAD_GLOBAL              RoommateLeaveReason
              272  LOAD_ATTR                OVERCAPACITY
              274  CALL_METHOD_2         2  '2 positional arguments'
              276  POP_TOP          

 L.1042       278  LOAD_FAST                'available_roommates'
              280  POP_JUMP_IF_TRUE_LOOP   246  'to 246'

 L.1043       282  BREAK_LOOP       
              284  JUMP_LOOP           246  'to 246'
              286  POP_BLOCK        
              288  JUMP_FORWARD        384  'to 384'
            290_0  COME_FROM           202  '202'

 L.1044       290  LOAD_FAST                'available_roommate_space'
              292  LOAD_FAST                'leaving_roommate_count'
              294  BINARY_ADD       
              296  LOAD_CONST               0
              298  COMPARE_OP               >
          300_302  POP_JUMP_IF_FALSE   384  'to 384'

 L.1045       304  LOAD_GLOBAL              services
              306  LOAD_METHOD              sim_info_manager
              308  CALL_METHOD_0         0  '0 positional arguments'
              310  STORE_FAST               'sim_info_manager'

 L.1046       312  LOAD_GLOBAL              random
              314  LOAD_METHOD              shuffle
              316  LOAD_FAST                'leaving_roommates'
              318  CALL_METHOD_1         1  '1 positional argument'
              320  POP_TOP          

 L.1047       322  LOAD_GLOBAL              min
              324  LOAD_FAST                'available_roommate_space'
              326  LOAD_FAST                'leaving_roommate_count'
              328  BINARY_ADD       
              330  LOAD_FAST                'leaving_roommate_count'
              332  CALL_FUNCTION_2       2  '2 positional arguments'
              334  STORE_FAST               'number_over'

 L.1048       336  SETUP_LOOP          384  'to 384'
              338  LOAD_GLOBAL              range
              340  LOAD_FAST                'number_over'
              342  CALL_FUNCTION_1       1  '1 positional argument'
              344  GET_ITER         
            346_0  COME_FROM           378  '378'
              346  FOR_ITER            382  'to 382'
              348  STORE_FAST               '_'

 L.1049       350  LOAD_FAST                'sim_info_manager'
              352  LOAD_METHOD              get
              354  LOAD_FAST                'leaving_roommates'
              356  LOAD_METHOD              pop
              358  CALL_METHOD_0         0  '0 positional arguments'
              360  CALL_METHOD_1         1  '1 positional argument'
              362  STORE_FAST               'sim_info'

 L.1050       364  LOAD_FAST                'self'
              366  LOAD_METHOD              remove_leave_reason
              368  LOAD_FAST                'sim_info'
              370  LOAD_GLOBAL              RoommateLeaveReason
              372  LOAD_ATTR                OVERCAPACITY
              374  CALL_METHOD_2         2  '2 positional arguments'
              376  POP_TOP          
          378_380  JUMP_LOOP           346  'to 346'
              382  POP_BLOCK        
            384_0  COME_FROM_LOOP      336  '336'
            384_1  COME_FROM           300  '300'
            384_2  COME_FROM           288  '288'
            384_3  COME_FROM_LOOP      230  '230'
            384_4  COME_FROM           208  '208'
            384_5  COME_FROM            34  '34'

 L.1052       384  LOAD_FAST                'self'
              386  LOAD_ATTR                _roommate_ids_to_update
          388_390  POP_JUMP_IF_FALSE   460  'to 460'

 L.1053       392  LOAD_GLOBAL              time
              394  LOAD_METHOD              clock
              396  CALL_METHOD_0         0  '0 positional arguments'
              398  STORE_FAST               'start_time'

 L.1054       400  SETUP_LOOP          522  'to 522'
            402_0  COME_FROM           452  '452'
              402  LOAD_GLOBAL              time
              404  LOAD_METHOD              clock
              406  CALL_METHOD_0         0  '0 positional arguments'
              408  LOAD_FAST                'start_time'
              410  BINARY_SUBTRACT  
              412  LOAD_FAST                'self'
              414  LOAD_ATTR                LEAVING
              416  LOAD_ATTR                time_slice_seconds
              418  COMPARE_OP               <
          420_422  POP_JUMP_IF_FALSE   456  'to 456'
              424  LOAD_FAST                'self'
              426  LOAD_ATTR                _roommate_ids_to_update
          428_430  POP_JUMP_IF_FALSE   456  'to 456'

 L.1056       432  LOAD_FAST                'self'
              434  LOAD_ATTR                _update_leave_reasons
              436  LOAD_FAST                'self'
              438  LOAD_ATTR                _roommate_ids_to_update
              440  LOAD_METHOD              pop
              442  CALL_METHOD_0         0  '0 positional arguments'
              444  LOAD_CONST               True
              446  LOAD_CONST               ('do_loot',)
              448  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
              450  POP_TOP          
          452_454  JUMP_LOOP           402  'to 402'
            456_0  COME_FROM           428  '428'
            456_1  COME_FROM           420  '420'
              456  POP_BLOCK        
              458  JUMP_FORWARD        522  'to 522'
            460_0  COME_FROM           388  '388'

 L.1058       460  LOAD_GLOBAL              services
              462  LOAD_METHOD              time_service
              464  CALL_METHOD_0         0  '0 positional arguments'
              466  LOAD_ATTR                sim_now
              468  STORE_FAST               'now'

 L.1059       470  LOAD_FAST                'self'
              472  LOAD_ATTR                _last_check_time
              474  LOAD_CONST               None
              476  COMPARE_OP               is
          478_480  POP_JUMP_IF_TRUE    504  'to 504'
              482  LOAD_FAST                'now'
              484  LOAD_FAST                'self'
              486  LOAD_ATTR                _last_check_time
              488  BINARY_SUBTRACT  
              490  LOAD_FAST                'self'
              492  LOAD_ATTR                LEAVING
              494  LOAD_METHOD              check_interval
              496  CALL_METHOD_0         0  '0 positional arguments'
              498  COMPARE_OP               >
          500_502  POP_JUMP_IF_FALSE   522  'to 522'
            504_0  COME_FROM           478  '478'

 L.1060       504  LOAD_FAST                'now'
              506  LOAD_FAST                'self'
              508  STORE_ATTR               _last_check_time

 L.1061       510  LOAD_GLOBAL              list
              512  LOAD_FAST                'self'
              514  LOAD_ATTR                _roommates_to_zone
              516  CALL_FUNCTION_1       1  '1 positional argument'
              518  LOAD_FAST                'self'
              520  STORE_ATTR               _roommate_ids_to_update
            522_0  COME_FROM           500  '500'
            522_1  COME_FROM           458  '458'
            522_2  COME_FROM_LOOP      400  '400'

Parse error at or near `JUMP_FORWARD' instruction at offset 458
    ...
    def _schedule_interviews(self):
        ...
        for _ in range(self.INTERVIEW.interviews_per_day.random_int()):
            ...
            handle = alarms.add_alarm(self, time_span, (lambda _: self._trigger_interview()
), cross_zone=True)
            self._interview_alarms.append(handle)

        self._interview_alarms = sorted((self._interview_alarms), key=(lambda x: x.finishing_time
), reverse=True)
    ...
    def remove_all_roommates_in_zone(self, zone_id, filter_func=None):
        ...
        for sim_id in sim_ids:
            if not filter_func is None or filter_func(sim_id):
                self._remove_roommate(sim_id)
    ...
    def on_all_households_and_sim_infos_loaded(self, client):
        ...
        for zone_id, household_data in self._zone_to_roommates.copy().items():
            ...
            if not venue is None or venue.is_university_housing:
    ...
    def _remove_excess_roommates(self, beds, bed_delta, max_possible_new, zone_id, unassigned_roommates, double_occupied_beds, single_occupied_beds):
        while unassigned_roommates:
            if bed_delta < 0 or max_possible_new < 0:
        ...
        for bed, sim_id in bed_to_sim_id.items():
            ...
            if not weighted_objects:
                ...
                for _ in range(self.DECORATING.number_to_place.random_int()):
                    ...
                    if not (weighted_objects and nearby_slots):
                        return
    ...
    def _update_alarms(self):
        ...
        if zone_id in self._zone_to_roommates and self._zone_to_roommates[zone_id].sim_ids:
            if self._rent_schedule_alarm is None:
                venue_manager = services.get_instance_manager(sims4.resources.Types.VENUE)
                venue = venue_manager.get(build_buy.get_current_venue(zone_id))
                self._rent_schedule_alarm = venue.is_university_housing or self.RENT.schedule(start_callback=(self._do_rent), schedule_immediate=False,
                  cross_zone=True)
        else:
            if self._rent_schedule_alarm is not None:
