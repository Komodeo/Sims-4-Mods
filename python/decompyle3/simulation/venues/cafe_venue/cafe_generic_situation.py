...
# Compiled at: 2018-07-12 15:54:26
...
class CafeGenericCustomerSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _PreOrderCoffeeState, factory=(cls.pre_order_coffee_state)),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.cafe_generic_job.job, cls.cafe_generic_job.role_state)]
...
class CafeGenericBackgroundSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _CafeGenericState),)

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.generic_sim_job.job, cls.generic_sim_job.role_state)]
