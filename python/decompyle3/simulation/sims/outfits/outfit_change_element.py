    ...
    def _run(self, timeline):
        ...
        if self.tests:
            ...
            if self.entry_outfit is not None:
                ...
                sequence = build_critical_section_with_finally(build_critical_section(maybe(lambda: self.outfit_change_entry_test.run_tests(resolver)
, self.outfit_change.get_on_entry_change((self.interaction), sim_info=(self.sim_info))), sequence), on_oufit_change_entry)
            if self.exit_outfit is not None:
                ...
                sequence = build_critical_section_with_finally(build_critical_section(sequence, maybe(lambda: self.outfit_change_exit_test.run_tests(resolver)
, self.outfit_change.get_on_exit_change((self.interaction), sim_info=(self.sim_info)))), on_oufit_change_exit)
