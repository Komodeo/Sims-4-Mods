...
# Compiled at: 2021-01-07 15:31:38
            ...
            if utility_info is not None:
                if not utility_info.active:
                    ...
                    if target:
                        ...
                        if not (tests and tests.run_tests(resolver, skip_safe_tests=skip_safe_tests)):
                            return TestResult(False, 'Bills: Interaction requires a utility that is shut off.',
