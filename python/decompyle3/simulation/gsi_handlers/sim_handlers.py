...
def generate_sim_info_toolbar_data--- This code section failed: ---

 L. 212         0  BUILD_LIST_0          0 
                2  STORE_FAST               'sim_info_data'

 L. 213         4  LOAD_GLOBAL              services
                6  LOAD_METHOD              sim_info_manager
                8  CALL_METHOD_0         0  '0 positional arguments'
               10  STORE_FAST               'sim_info_manager'

 L. 214        12  LOAD_FAST                'sim_info_manager'
               14  LOAD_CONST               None
               16  COMPARE_OP               is
               18  POP_JUMP_IF_FALSE    24  'to 24'

 L. 215        20  LOAD_FAST                'sim_info_data'
               22  RETURN_VALUE     
             24_0  COME_FROM            18  '18'

 L. 217        24  BUILD_LIST_0          0 
               26  STORE_FAST               'selectable_sims'

 L. 218        28  BUILD_LIST_0          0 
               30  STORE_FAST               'instanced_sims'

 L. 219        32  BUILD_LIST_0          0 
               34  STORE_FAST               'uninstanced_sims'

 L. 221        36  SETUP_LOOP          172  'to 172'
               38  LOAD_GLOBAL              list
               40  LOAD_FAST                'sim_info_manager'
               42  LOAD_ATTR                objects
               44  CALL_FUNCTION_1       1  '1 positional argument'
               46  GET_ITER         
             48_0  COME_FROM           168  '168'
             48_1  COME_FROM           156  '156'
             48_2  COME_FROM           136  '136'
               48  FOR_ITER            170  'to 170'
               50  STORE_FAST               'sim_info'

 L. 222        52  LOAD_FAST                'sim_info'
               54  LOAD_ATTR                first_name
               56  POP_JUMP_IF_TRUE     72  'to 72'
               58  LOAD_FAST                'sim_info'
               60  LOAD_ATTR                last_name
               62  POP_JUMP_IF_TRUE     72  'to 72'

 L. 223        64  LOAD_FAST                'sim_info'
               66  LOAD_ATTR                full_name
               68  STORE_FAST               'full_name'
               70  JUMP_FORWARD         88  'to 88'
             72_0  COME_FROM            62  '62'
             72_1  COME_FROM            56  '56'

 L. 225        72  LOAD_FAST                'sim_info'
               74  LOAD_ATTR                first_name
               76  LOAD_STR                 ' '
               78  BINARY_ADD       
               80  LOAD_FAST                'sim_info'
               82  LOAD_ATTR                last_name
               84  BINARY_ADD       
               86  STORE_FAST               'full_name'
             88_0  COME_FROM            70  '70'

 L. 227        88  LOAD_GLOBAL              str
               90  LOAD_GLOBAL              hex
               92  LOAD_FAST                'sim_info'
               94  LOAD_ATTR                sim_id
               96  CALL_FUNCTION_1       1  '1 positional argument'
               98  CALL_FUNCTION_1       1  '1 positional argument'
              100  LOAD_FAST                'full_name'

 L. 228       102  LOAD_FAST                'sim_info'
              104  LOAD_ATTR                is_selectable
              106  LOAD_FAST                'sim_info'
              108  LOAD_METHOD              is_instanced
              110  CALL_METHOD_0         0  '0 positional arguments'
              112  LOAD_CONST               ('simId', 'fullName', 'selectable', 'isInstanced')
              114  BUILD_CONST_KEY_MAP_4     4 
              116  STORE_FAST               'cur_data_entry'

 L. 229       118  LOAD_FAST                'cur_data_entry'
              120  LOAD_STR                 'selectable'
              122  BINARY_SUBSCR    
              124  POP_JUMP_IF_FALSE   138  'to 138'

 L. 230       126  LOAD_FAST                'selectable_sims'
              128  LOAD_METHOD              append
              130  LOAD_FAST                'cur_data_entry'
              132  CALL_METHOD_1         1  '1 positional argument'
              134  POP_TOP          
              136  JUMP_LOOP            48  'to 48'
            138_0  COME_FROM           124  '124'

 L. 231       138  LOAD_FAST                'cur_data_entry'
              140  LOAD_STR                 'isInstanced'
              142  BINARY_SUBSCR    
              144  POP_JUMP_IF_FALSE   158  'to 158'

 L. 232       146  LOAD_FAST                'instanced_sims'
              148  LOAD_METHOD              append
              150  LOAD_FAST                'cur_data_entry'
              152  CALL_METHOD_1         1  '1 positional argument'
              154  POP_TOP          
              156  JUMP_LOOP            48  'to 48'
            158_0  COME_FROM           144  '144'

 L. 234       158  LOAD_FAST                'uninstanced_sims'
              160  LOAD_METHOD              append
              162  LOAD_FAST                'cur_data_entry'
              164  CALL_METHOD_1         1  '1 positional argument'
              166  POP_TOP          
              168  JUMP_LOOP            48  'to 48'
              170  POP_BLOCK        
            172_0  COME_FROM_LOOP       36  '36'

 L. 236       172  LOAD_GLOBAL              sorted
              174  LOAD_FAST                'selectable_sims'
              176  LOAD_LAMBDA              '<code_object <lambda>>'
              178  LOAD_STR                 'generate_sim_info_toolbar_data.<locals>.<lambda>'
              ...
              186  STORE_FAST               'selectable_sims'

 L. 237       188  LOAD_GLOBAL              sorted
              190  LOAD_FAST                'instanced_sims'
              192  LOAD_LAMBDA              '<code_object <lambda>>'
              194  LOAD_STR                 'generate_sim_info_toolbar_data.<locals>.<lambda>'
              ...
              202  STORE_FAST               'instanced_sims'

 L. 238       204  LOAD_GLOBAL              sorted
              206  LOAD_FAST                'uninstanced_sims'
              208  LOAD_LAMBDA              '<code_object <lambda>>'
              210  LOAD_STR                 'generate_sim_info_toolbar_data.<locals>.<lambda>'
              ...
              218  STORE_FAST               'uninstanced_sims'

 L. 239       220  LOAD_GLOBAL              list
              222  LOAD_GLOBAL              itertools
              224  LOAD_METHOD              chain
              226  LOAD_FAST                'selectable_sims'
              228  LOAD_FAST                'instanced_sims'
              230  LOAD_FAST                'uninstanced_sims'
              232  CALL_METHOD_3         3  '3 positional arguments'
              234  CALL_FUNCTION_1       1  '1 positional argument'
              236  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `LOAD_GLOBAL' instruction at offset 88
...
def generate_sim_info_data(*args, zone_id: int=None, **kwargs):
    ...
    sort_key_fn = lambda data: (
     data['selectable'] != True, data['firstName'])
...
def create_state_info_entry(interaction, interaction_pos):
    ...
    if interaction._conditional_action_manager is not None:
        ...
        for group in interaction._conditional_action_manager:
            ...
            group_entry['unsatisfied_conditions'] = ',\n'.join((str(c) for c in group if not c.satisfied if  if not c.satisfied))
...
def generate_available_buffs_list(*args, sim_id: int=None, filter=None, **kwargs):
    ...
    for key, buff in buff_instance_manager.types.items():
        ...
        if buff.can_add(sim_info):
            ...
            if FILTER_UNAVAILABLE_FOR_SIM not in filter:
                continue
...
def enable_sim_motive_graph_logging(*args, enableLog=False, **kwargs):
    ...
    if enableLog and sim_motive_graph_alarm is None:
        sim_motive_graph_alarm = alarms.add_alarm(sim_motive_archiver, (TimeSpan(5000)), (lambda _: archive_sim_motives()
), repeating=True)
    else:
    ...
    if sim_info.statistic_tracker is not None:
        for stat in list(sim_info.statistic_tracker):
            entry = {'simId':str(sim_id), 
             ...
             'type':'Statistic', 
             'data':'min={}, max={}, current={}'.formatstat.min_valuestat.max_valuestat.get_value()}
            vital_view_data.append(entry)
