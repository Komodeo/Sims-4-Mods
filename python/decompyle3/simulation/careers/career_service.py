    ...
    def try_add_pending_career_event_offer(self, career, career_event):
        ...
        if career.is_multi_sim_active:
            for pending_event in self._pending_career_events:
                if pending_event.career_event == career_event:
                    if career in pending_event.additional_careers:
                        return
            ...
            for sim_info in household.sim_info_gen():
                ...
                if additional_career is not None:
                    if additional_career.follow_enabled:
                        if career_event in additional_career.career_events:
