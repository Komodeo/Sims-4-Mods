...
# Compiled at: 2018-07-25 13:02:55
...
class RetailCustomerSituation(BusinessSituationMixin, SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _GoToStoreState),
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.customer_job, cls.role_state_go_to_store)]
    ...
    def _on_social_group_changed(self, sim, group):
        if self._customer is not None:
            if self._customer in group:
                ...
                if self._on_social_group_members_changed in group.on_group_changed:
