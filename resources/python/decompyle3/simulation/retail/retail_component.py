...
# Compiled at: 2019-01-16 17:18:20
    ...
    def on_state_changed(self, state, old_value, new_value, from_init):
        ...
        if new_value is self.NOT_FOR_SALE_STATE or new_value is self.DEFAULT_SALE_STATE:
            ...
            if new_value is self.FOR_SALE_STATE:
                ...
                if new_value is self.SOLD_STATE:
    ...
    def component_super_affordances_gen(self, **kwargs):
        ...
        if sellable_data is not None:
            if self.is_for_sale:
                ...
                if self.is_not_for_sale:
                    if not sellable_data.set_for_sale_affordance is not None or self.get_can_be_sold():
