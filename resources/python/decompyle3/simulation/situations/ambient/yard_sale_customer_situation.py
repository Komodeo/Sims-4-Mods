...
# Compiled at: 2018-07-22 14:19:12
...
class YardSaleCustomerSituation(SituationComplexCommon):
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.customer_job_and_role_state.job, cls.customer_job_and_role_state.role_state)]
    ...
    def _states(cls):
        return (
         SituationStateData(1, BrowseItemsState, factory=(cls.browse_items_state)),)
