...
# Compiled at: 2018-05-14 15:33:09
...
class ScarecrowSituation(ObjectBoundSituationMixin, SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _DoStuffState, partial((cls._do_stuff_state), situation_job=(cls._situation_job))),
    ...
    def handle_event(self, sim_info, event, resolver):
        if event == TestEvent.InteractionStart:
            if not self.is_sim_info_in_situation(sim_info) or resolver(self._spawn_object_targeting_affordance):
