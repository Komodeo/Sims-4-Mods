...
# Compiled at: 2019-02-14 16:38:38
...
class SuntannerSituation(GiveJobObjectSituationMixin, SituationComplexCommon):
    ...
    def _states(cls):
        return [
         SituationStateData(1, _SuntannerSituationState, factory=(cls.default_state))]

    @classmethod
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.situation_default_job_and_role.job, cls.situation_default_job_and_role.role_state)]
