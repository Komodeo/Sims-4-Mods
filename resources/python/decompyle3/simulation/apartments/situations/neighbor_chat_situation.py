...
# Compiled at: 2016-09-06 20:25:38
...
class NeighborChatSituation(SituationComplexCommon):
    ...
    def _states(cls):
        return (
         SituationStateData(1, _WaitForNeighborToSpawnState),
    ...
    def _on_set_sim_job(self, sim, job_type):
        ...
        if self._neighbor_sim is not None:
            if self._knocker_sim is not None:
    ...
    def _get_tuned_job_and_default_role_state_tuples(cls):
        return [
         (
          cls.neighbor_job_and_role_state.job, cls.neighbor_job_and_role_state.role_state),
         (
